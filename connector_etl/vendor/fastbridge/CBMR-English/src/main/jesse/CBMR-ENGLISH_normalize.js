var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "CBMR_ENGLISH";
    ...
    */
    ...
    var scoresToMap =
        [
           {TEST: "CBMRENG", CODE:"Fall", FIELD: "FALL_CBMR-ENGLISH_", MAP_FUNCTION: mapScaledScore}
           , {TEST: "CBMRENG", CODE:"Winter", FIELD: "WINTER_CBMR-ENGLISH_", MAP_FUNCTION: mapScaledScore}
           , {TEST: "CBMRENG", CODE:"Spring", FIELD: "SPRING_CBMR-ENGLISH_", MAP_FUNCTION: mapScaledScore}
           , {TEST: "CBMRENG", CODE:"Winter_FW", FIELD: "_FROM_FALL_TO_WINTER", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Spring_FS", FIELD: "_FROM_FALL_TO_SPRING", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Spring_WS", FIELD: "_FROM_WINTER_TO_SPRING", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Winter_FTFM", FIELD: "_FROM_FALL_TO_FEB-MAR", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Winter_WTFM", FIELD: "_FROM_WINTER_TO_FEB-MAR", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Winter_FMTS", FIELD: "_FROM_FEB-MAR_TO_SPRING", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Spring_FS", FIELD: "_FROM_FALL_TO_SPRING_MS", MAP_FUNCTION: mapGrowthScore}
           , {TEST: "CBMRENG", CODE:"Winter_FTM", FIELD: "FEB-MAR_CBMR-ENGLISH_", MAP_FUNCTION: mapScaledScore}
           , {TEST: "CBMRENG", CODE:"Spring", FIELD: "SPRING_MS_CBMR-ENGLISH_", MAP_FUNCTION: mapScaledScore}

           ,{TEST: "CBMRENG", CODE:"Fall_P1", FIELD: "FALL_CBMR-ENGLISH_(PASSAGE_1)_", MAP_FUNCTION: mapStrand1Score}
           ,{TEST: "CBMRENG", CODE:"Fall_P2", FIELD: "FALL_CBMR-ENGLISH_(PASSAGE_2)_", MAP_FUNCTION: mapStrand2Score}
           ,{TEST: "CBMRENG", CODE:"Fall_P3", FIELD: "FALL_CBMR-ENGLISH_(PASSAGE_3)_", MAP_FUNCTION: mapStrand3Score}
           ,{TEST: "CBMRENG", CODE:"Winter_P1", FIELD: "WINTER_CBMR-ENGLISH_(PASSAGE_1)_", MAP_FUNCTION: mapStrand1Score}
           ,{TEST: "CBMRENG", CODE:"Winter_P2", FIELD: "WINTER_CBMR-ENGLISH_(PASSAGE_2)_", MAP_FUNCTION: mapStrand2Score}
           ,{TEST: "CBMRENG", CODE:"Winter_P3", FIELD: "WINTER_CBMR-ENGLISH_(PASSAGE_3)_", MAP_FUNCTION: mapStrand3Score}
           ,{TEST: "CBMRENG", CODE:"Spring_P1", FIELD: "SPRING_CBMR-ENGLISH_(PASSAGE_1)_", MAP_FUNCTION: mapStrand1Score}
           ,{TEST: "CBMRENG", CODE:"Spring_P2", FIELD: "SPRING_CBMR-ENGLISH_(PASSAGE_2)_", MAP_FUNCTION: mapStrand2Score}
           ,{TEST: "CBMRENG", CODE:"Spring_P3", FIELD: "SPRING_CBMR-ENGLISH_(PASSAGE_3)_", MAP_FUNCTION: mapStrand3Score}
           ,{TEST: "CBMRENG", CODE:"Spring_P1", FIELD: "SPRING_MS_CBMR-ENGLISH_(PASSAGE_1)_", MAP_FUNCTION: mapStrand1Score}
           ,{TEST: "CBMRENG", CODE:"Spring_P2", FIELD: "SPRING_MS_CBMR-ENGLISH_(PASSAGE_2)_", MAP_FUNCTION: mapStrand2Score}
           ,{TEST: "CBMRENG", CODE:"Spring_P3", FIELD: "SPRING_MS_CBMR-ENGLISH_(PASSAGE_3)_", MAP_FUNCTION: mapStrand3Score}
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row, period) {
        ...
        var springDate = _util.coalesce(row.getField("SPRING_CBMR-ENGLISH_FINAL_DATE"),row.getField("SPRING_MS_CBMR-ENGLISH_FINAL_DATE"));
        var winterDate = _util.coalesce(row.getField("WINTER_CBMR-ENGLISH_FINAL_DATE"),row.getField("FEB-MAR_CBMR-ENGLISH_FINAL_DATE"));
        var fallDate = row.getField("FALL_CBMR-ENGLISH_FINAL_DATE");
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE = AppUtil.getDateObjByPattern(recentDate, "MM/d/yyyy").STANDARD_DATE;
                    break;
    ...
    function generateAssessmentAdminKey(signature, hierarchy, srcRecord, period) {
        ...
        // Add the Final date
        if(period === "Fall") {
            if(srcRecord.getField("FALL_CBMR-ENGLISH_FINAL_DATE")) {
                assessmentAdminKey = assessmentAdminKey +  "_" + _util.coalesce(srcRecord.getField("FALL_CBMR-ENGLISH_FINAL_DATE"),"");
            } else {
                // Default date for FALL
                assessmentAdminKey = assessmentAdminKey +  "_" + "09/15/" + "${hierarchy.SCHOOL_YEAR.substring(0,4)}";
            }
        } else if(period === "Winter") {
            if(_util.coalesce(srcRecord.getField("WINTER_CBMR-ENGLISH_FINAL_DATE"),srcRecord.getField("FEB-MAR_CBMR-ENGLISH_FINAL_DATE"))) {
                assessmentAdminKey = assessmentAdminKey +  "_" + _util.coalesce(srcRecord.getField("WINTER_CBMR-ENGLISH_FINAL_DATE"),srcRecord.getField("FEB-MAR_CBMR-ENGLISH_FINAL_DATE"),"");
            } else {
                // Default date for WINTER
                assessmentAdminKey = assessmentAdminKey +  "_" + "01/15/" + "${hierarchy.SCHOOL_YEAR.substring(0,4)}";
            }
        } else if(period ==="Spring") {
            if(srcRecord.getField("SPRING_CBMR-ENGLISH_FINAL_DATE")) {
                assessmentAdminKey = assessmentAdminKey +  "_" + _util.coalesce(srcRecord.getField("SPRING_CBMR-ENGLISH_FINAL_DATE"),"");
            } else {
