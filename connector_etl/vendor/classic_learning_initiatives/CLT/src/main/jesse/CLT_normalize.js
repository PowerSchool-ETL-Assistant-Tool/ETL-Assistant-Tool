var AppNormalize = (function() {
    ...
    var scoresToMap = [
        {TEST: "CLT", CODE: "TOTAL", FIELD: "TOT", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CLT", CODE: "Verbal Reasoning", FIELD: "VR", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CLT", CODE: "Grammar/Writing", FIELD: "GW", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CLT", CODE: "Quantitative Reasoning", FIELD: "QR", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CLT", CODE: "National", FIELD: "NA", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapScaledScore(row, testMetadata) {
        ...
        var percentile = row.getField(testMetadata.FIELD + "_PERCENTILE_SCORE");

        // Check for key fields and do not map score and exit if conditions met.
        if((scaleScore === null || scaleScore === undefined || _util.trim(scaleScore) === "--" || _util.trim(scaleScore) === "") &&
         (percentile === null || percentile === undefined || _util.trim(percentile) === "--" || _util.trim(percentile) === "") || percentile === "1-" || percentile === "99+") {
            return null;
        }
    ...
    function getTestNumber(row, tmd){
            ...
            if(fileName.indexOf("CLT8") >-1){
                testNumber = tmd.TEST + '8_' + tmd.FIELD;
                }else if(fileName.indexOf("CLT10") >-1){
                    testNumber = tmd.TEST + '10_' + tmd.FIELD;
            }
             else{
                  testNumber = tmd.TEST + '_' + tmd.FIELD;
             }
               return testNumber;
    }
