var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "star_phonics";
    ...
    var scoresToMap = [
        {TEST: "STAR_PHONICS", CODE:"CNT", FIELD: "CONTRACTIONS", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"CVC", FIELD: "CVC", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"CVCC", FIELD: "CVCC", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"DGPH", FIELD: "DIGRAPH", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"BLND", FIELD: "BLEND", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"RC", FIELD: "R_CONTROL", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"VT", FIELD: "VOWEL_TEAMS", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"CVCE", FIELD: "CVCE", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"SVSFX", FIELD: "SV_SUFFIX", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"CVCCVC", FIELD: "CVCCVC", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"PFX", FIELD: "PREFIX", MAP_FUNCTION: mapScaledScore},
        {TEST: "STAR_PHONICS", CODE:"LVSFX", FIELD: "LV_SUFFIX", MAP_FUNCTION: mapScaledScore},
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "REPORTING_PERIOD":
                    record.REPORTING_PERIOD = _util.coalesce(row.getField("TIME_OF_YEAR")), hierarchy.REPORTING_PERIOD;
                    break;
