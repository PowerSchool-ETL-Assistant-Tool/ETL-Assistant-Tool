...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/IREADY_PERSONALIZED_INSTRUCTION_normalize.js");
    ...
    AppConnectorTest.QUnit.test("iready_Personalized_Instruction TESTS", function (assert) {
