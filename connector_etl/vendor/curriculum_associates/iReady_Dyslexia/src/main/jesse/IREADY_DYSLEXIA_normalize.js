var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "IREADY_DYSLEXIA";
    ...
    var scoresToMap = [
        {TEST: "IREADY_DX", CODE:"OVR", FIELD: "OVERALL", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "IREADY_DX", CODE:"PHON_AWARE", FIELD: "PHONOLOGICAL_AWARENESS", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "IREADY_DX", CODE:"PHONICS", FIELD: "PHONICS", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "IREADY_DX", CODE:"COMP_LIT", FIELD: "COMPREHENSION_LITERATURE", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "IREADY_DX", CODE:"COMP_INFO_TEXT", FIELD: "COMPREHENSION_INFORMATIONAL_TEXT", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "IREADY_DX", CODE:"MN_COMP_DOM", FIELD: "MEAN_COMPREHENSION_DOMAIN", MAP_FUNCTION: mapScaledScore}
    ];
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "REPORTING_PERIOD":
                    record.REPORTING_PERIOD = _util.coalesce(row.getField("PERIOD"),hierarchy.REPORTING_PERIOD);
                    break;
