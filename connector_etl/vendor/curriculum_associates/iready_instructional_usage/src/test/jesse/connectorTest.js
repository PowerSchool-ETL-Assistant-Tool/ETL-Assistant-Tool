...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/IREADY_INSTRUCTIONAL_USAGE_normalize.js");
    ...
    AppConnectorTest.QUnit.test("iready_instructional_usage TESTS", function (assert) {
