{
	...
	"format": {
		"@type": "Delimited",
		"formatName": "PSATNMSQT_PSAT10_REDESIGN_DELIMITED",
		"quoteDelim": "\"",
		"fieldDelim": ",",
		"hasHeader": true,
		...
		"fields": [{
			...
			{
				"physicalName": "FILLER_69",
				"otherPossibleNames": [],
				"logicalName": "FILLER_69",
				"formatMask": null,
				"isFieldRequired": "N",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "SELECTION_INDEX_PERCENTILE",
				"otherPossibleNames": ["FILLER_32"],
				"logicalName": "SELECTION_INDEX_PERCENTILE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "SDQ_CITIZENSHIP",
				"otherPossibleNames": ["FILLER_31"],
			...
			{
				"physicalName": "DUAL_PREALGEBRA",
				"otherPossibleNames": ["FILLER_34"],
				"logicalName": "DUAL_PREALGEBRA",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_ALGEBRA",
				"otherPossibleNames": ["FILLER_37"],
				"logicalName": "DUAL_ALGEBRA",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_ALGEBRAII",
				"otherPossibleNames": ["FILLER_40"],
				"logicalName": "DUAL_ALGEBRAII",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "HONORS_ALGEBRAII",
				"otherPossibleNames": ["FILLER_41"],
				"logicalName": "HONORS_ALGEBRAII",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_GEOMETRY",
				"otherPossibleNames": ["FILLER_43"],
				"logicalName": "DUAL_GEOMETRY",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_TRIGONOMETRY",
				"otherPossibleNames": ["FILLER_46"],
				"logicalName": "DUAL_TRIGONOMETRY",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_PRECALCULUS",
				"otherPossibleNames": ["FILLER_49"],
				"logicalName": "DUAL_PRECALCULUS",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_CALCULUS",
				"otherPossibleNames": ["FILLER_52"],
				"logicalName": "DUAL_CALCULUS",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_INT_MATH",
				"otherPossibleNames": ["FILLER_55"],
				"logicalName": "DUAL_INT_MATH",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "HONORS_INT_MATH",
				"otherPossibleNames": ["FILLER_56"],
				"logicalName": "HONORS_INT_MATH",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "DUAL_STATISTICS",
				"otherPossibleNames": ["FILLER_58"],
				"logicalName": "DUAL_STATISTICS",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
