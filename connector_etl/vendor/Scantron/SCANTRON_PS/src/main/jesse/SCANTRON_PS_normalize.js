var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "SCANTRON_PS";
    ...
    var scoresToMap = [
        {TEST: "SCANTRON_PS", CODE:"_READ_ELA", FIELD: "READING_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "SCANTRON_PS", CODE:"_MATH", FIELD: "MATH_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "SCANTRON_PS", CODE:"_SCI", FIELD: "SCIENCE_", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    var performanceLevelDecode = {
        "1" : {CODE: "1", DESC: "Emerging Learner", PASS_IND: "No"}
        ,"2" : {CODE: "2", DESC: "Developing Learner", PASS_IND: "No"}
        ,"3" : {CODE: "3", DESC: "Proficient Learner", PASS_IND: "Yes"}
        ,"4" : {CODE: "4", DESC: "Distinguished Learner", PASS_IND: "Yes"}
        ,"N/A"  : {CODE: null, DESC: null, PASS_IND: null}
        ,"" : {CODE: null, DESC: null, PASS_IND: null}
        ,null : {CODE: null, DESC: null, PASS_IND: null}
       };

    var growthLevelDecode = {
        "1" : {CODE: "1", DESC: "Far Below"}
        ,"2" : {CODE: "2", DESC: "Developing Learner"}
        ,"3" : {CODE: "3", DESC: "Proficient Learner"}
        ,"4" : {CODE: "4", DESC: "Distinguished Learner"}
        ,"N/A"  : {CODE: null, DESC: null}
        ,"" : {CODE: null, DESC: null}
        ,null : {CODE: null, DESC: null}
       };

    var targetLevelDecode = {
        "1" : {CODE: "1", PASS_IND: "Yes"}
        ,"0" : {CODE: "0", PASS_IND: "No"}
        ,"N/A"  : {CODE: null, DESC: null}
        ,"" : {CODE: null, DESC: null}
        ,null : {CODE: null, DESC: null}
       };
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var reportperiod = getTEST_ADMIN_PERIOD(row, hierarchy)
        var stddate =  getAdminDate(row, hierarchy)
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "REPORTING_PERIOD":
                    record.REPORTING_PERIOD = reportperiod;
                    break;
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE = stddate;
                    break;
    ...
    function mapScaledScore(row, testMetadata) {
        ...
        var achievLevel = row.getField(testMetadata.FIELD + "PROFICIENCY_LEVEL");
        var growth = row.getField(testMetadata.FIELD + "GROWTH_CATEGORY");
        var target = row.getField(testMetadata.FIELD + "TARGET_MET");
    	...
    	score["TEST_PRIMARY_RESULT_CODE"] = performanceLevelDecode[achievLevel].CODE;
    	score["TEST_PRIMARY_RESULT"] = performanceLevelDecode[achievLevel].DESC;
    	score["TEST_PASSED_INDICATOR"] = targetLevelDecode[target].PASS_IND;
    	score["TEST_GROWTH_RESULT_CODE"] = growthLevelDecode[growth].CODE;
    	score["TEST_GROWTH_RESULT"] = growthLevelDecode[growth].DESC;
