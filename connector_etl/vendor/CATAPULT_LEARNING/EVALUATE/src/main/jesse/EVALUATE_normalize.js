var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "EVALUATE";
    ...
    var scoresToMap = [
        {TEST: "EVALUATE", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var testDate = row.getField("TIME_SUBMITTED");
        if(testDate !== null && testDate !== undefined && testDate !== ""){
            var testAdminDate = AppUtil.getMonthFollowedByDay(testDate).STANDARD_DATE;
        }
        var period = getAdminPeriod(testAdminDate);
    ...
    function getAdminPeriod(testAdminDate) {
    try{
        let period = 'ALL';
        var month;
    ...
    function mapScaledScore(row, testMetadata) {
        ...
        var testNumber = testMetadata.TEST + "_" + subjectDecode[subject];
        var scaleScore = row.getField("SCALED_SCORE");
		var profLevel = row.getField("PROFICIENCY");
    	...
    	score["TEST_PRIMARY_RESULT_CODE"] = profDecode[profLevel];
    ...
    function generateAssessmentAdminKey(signature, hierarchy, srcRecord) {
        ...
        var date = srcRecord.getField("TIME_SUBMITTED");
        if(date !== null && date !== undefined && date !== ""){
            var adminDate = AppUtil.getMonthFollowedByDay(date).STANDARD_DATE;
        }
        // Add normalized grade code
        var grade = gradeDecode[srcRecord.getField('GRADE')];
        //Add natural key fields
        signature.getFormat().getNaturalKey().forEach(function(key) {
            assessmentAdminKey = assessmentAdminKey + "_" + _util.coalesce(srcRecord.getField(key),"");
        });
        assessmentAdminKey = assessmentAdminKey + "_" + grade + "_" + adminDate;
