...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/IOWA_normalize.js");
    ...
    AppConnectorTest.QUnit.test("IOWA TESTS", function (assert) {
    ...
    //AppConnectorTest.QUnit.test("IOWA DATE TRANSFORMATION TESTS", function (assert) {
        //assert.equal(AppNormalize.mapDateObject(null, null, '10-05-2020').STANDARD_DATE, '10/05/2020');
        //assert.equal(AppNormalize.mapDateObject(null, null, '06-30-2021').STANDARD_DATE, '06/30/2021');
        //assert.equal(AppNormalize.mapDateObject(null, null, '09262021').STANDARD_DATE, '09/26/2021');
        //assert.equal(AppNormalize.mapDateObject(null, null, '03032020').STANDARD_DATE, '03/03/2020');
    //});
