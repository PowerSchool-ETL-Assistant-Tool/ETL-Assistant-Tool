var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "LITERACY_SQUARED";
    ...
    var scoresToMap = [
        {TEST: "LITERACY_SQUARED", CODE:"CONT_SPA", FIELD: "CONTENT_SPANISH", MAP_FUNCTION: mapScaledScore}
       , {TEST: "LITERACY_SQUARED", CODE:"CONT_ENG", FIELD: "CONTENT_ENGLISH", MAP_FUNCTION: mapScaledScore}
       , {TEST: "LITERACY_SQUARED", CODE:"STRUC_SPA", FIELD: "STRUCTURE_SPANISH", MAP_FUNCTION: mapScaledScore}
       , {TEST: "LITERACY_SQUARED", CODE:"STRUC_ENG", FIELD: "STRUCTURE_ENGLISH", MAP_FUNCTION: mapScaledScore}
       , {TEST: "LITERACY_SQUARED", CODE:"SPEL_SPA", FIELD: "SPELLING_SPANISH", MAP_FUNCTION: mapScaledScore}
       , {TEST: "LITERACY_SQUARED", CODE:"SPEL_ENG", FIELD: "SPELLING_ENGLISH", MAP_FUNCTION: mapScaledScore}
    ];
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE =  AppUtil.getDateObjByPattern(row.getField("TEST_ADMIN_DATE"), "M/d/yyyy").STANDARD_DATE;
                    break;
    ...
    function getGrade(row){
         var record = {};
         var grade = null;
         var courseSubject = row.getField("COURSE_NAME").replaceAll(" ","");
         if(courseSubject.indexOf("GradeK") > -1){
            grade = "KG";
         }else if(courseSubject.indexOf("Grade1") > -1){
            grade = "01";
         }else if(courseSubject.indexOf("Grade2") > -1){
            grade = "02";
         }else if(courseSubject.indexOf("Grade3") > -1){
            grade = "03";
         }else if(courseSubject.indexOf("Grade4") > -1){
            grade = "04";
         }else if(courseSubject.indexOf("Grade5") > -1){
            grade = "05";
         }
         return grade;
    }
