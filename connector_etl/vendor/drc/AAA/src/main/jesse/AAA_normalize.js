var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "AAA";
    var _thisLineageSource = "Edvantage ${_assessmentIdentifier} Loader v1.0";
    var multipleRowsPerGroupingExpected = false;
    //This connector was created in UIHN-30757
    /**
    ...
    var scoresToMap =
        [
             {TEST: "AAA_", CODE:"OVR", FIELD: "READING", MAP_FUNCTION: mapScaleScore}
            ,{TEST: "AAA_", CODE:"OVR", FIELD: "MATHEMATICS", MAP_FUNCTION: mapScaleScore}
            ,{TEST: "AAA_", CODE:"OVR", FIELD: "SCIENCE", MAP_FUNCTION: mapScaleScore}
        ];
    ...
    var gradeDecode = {
     ...
     var performanceLvlDecode = {
        "1" : {DESC: "Does Not Meet Standards", PASSED: "No"}
       ,"2" : {DESC: "Partially Meets Standards", PASSED: "No"}
       ,"3" : {DESC: "Meets Standards", PASSED: "Yes"}
       ,"4" : {DESC: "Exceeds Standards", PASSED: "Yes"}
       ,null :{DESC: null, PASSED: null}
     };
    /***********************************************************************************
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        if(schoolName){
            var schName = schoolName.replace(/[^a-zA-Z]+/g,' ').trim();
            var schoolLocalId = schoolName.replace(/\D+/g,' ').trim();
        }
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "SCHOOL_VENDOR_ID":
                    record.SCHOOL_VENDOR_ID = _util.coalesce(schoolLocalId);
                    break;
                case "SCHOOL_STATE_ID":
                    record.SCHOOL_STATE_ID = _util.coalesce(schoolLocalId);
                    break;
                case "SCHOOL_LOCAL_ID":
                    record.SCHOOL_LOCAL_ID = _util.coalesce(schoolLocalId);
                    break;
                case "SCHOOL_NAME":
    ...
    function mapScaleScore(row, testMetadata) {
        ...
        var achievementLevel = row.getField(testMetadata.FIELD + "_" + "ACHIEVEMENT_LEVEL");
    	...
    	score["TEST_PRIMARY_RESULT"] = performanceLvlDecode[achievementLevel].DESC;
    	score["TEST_PASSED_INDICATOR"] = performanceLvlDecode[achievementLevel].PASSED;
