var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "PRE-LAS";
    ...
    var scoresToMap = [
        {TEST: "PRE-LAS", CODE:"ORL", FIELD: "ORAL", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapAdditionalAdminFields(row) {
        ...
        admin.STUDENT_LEP_CODE = row.getField("LEP_STATUS");
    ...
    function mapScaledScore(row, testMetadata) {
        var score = {};
        var testType = testDecode[row.getField("TEST_TYPE")];

        var testNumber = testMetadata.TEST + "_" + testType + "_" +  testMetadata.CODE;
        var scaleScore = row.getField(testMetadata.FIELD + "_SCALE_SCORE");
		var achievLevel = row.getField(testMetadata.FIELD + "_PROFICIENCY_LEVEL");
        var gradeEquivalent = row.getField("TEST_GRADE_LEVEL");
