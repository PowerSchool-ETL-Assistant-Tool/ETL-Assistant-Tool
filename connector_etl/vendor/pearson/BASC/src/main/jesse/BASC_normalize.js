var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "BASC";
    ...
    var scoresToMap = [
        {TEST: "BASC_", NUMBER: "R", FIELD: "", MAP_FUNCTION: mapScaledScore},

        //PrimaryScore
        {TEST: "BASC_", CODE:"AD", FIELD: "BASC3_AD", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"AG", FIELD: "BASC3_AG", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"AX", FIELD: "BASC3_AX", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"AP", FIELD: "BASC3_AP", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"AY", FIELD: "BASC3_AY", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"CP", FIELD: "BASC3_CP", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"DP", FIELD: "BASC3_DP", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"FC", FIELD: "BASC3_FC", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"HA", FIELD: "BASC3_HA", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"LE", FIELD: "BASC3_LE", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"LP", FIELD: "BASC3_LP", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"SO", FIELD: "BASC3_SO", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"SM", FIELD: "BASC3_SM", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"SK", FIELD: "BASC3_SK", MAP_FUNCTION: mapPrimaryScore},
        {TEST: "BASC_", CODE:"WD", FIELD: "BASC3_WD", MAP_FUNCTION: mapPrimaryScore},

        //CompositeScore
        {TEST: "BASC_", CODE:"ASI", FIELD: "BASC3_ASI", MAP_FUNCTION: mapCompositeScore},
        {TEST: "BASC_", CODE:"BSI", FIELD: "BASC3_BSI", MAP_FUNCTION: mapCompositeScore},
        {TEST: "BASC_", CODE:"EPI", FIELD: "BASC3_EPI", MAP_FUNCTION: mapCompositeScore},
        {TEST: "BASC_", CODE:"IPI", FIELD: "BASC3_IPI", MAP_FUNCTION: mapCompositeScore},
        {TEST: "BASC_", CODE:"SPI", FIELD: "BASC3_SPI", MAP_FUNCTION: mapCompositeScore},

        //PerformanceScore
        {TEST: "BASC_", NUMBER:"EDI", FIELD: "", MAP_FUNCTION: mapPerfScore}
    ];
    ...
    var perfLevelDecode = {
        "At-Risk" : { DESC:"At-Risk", PASS_IND: "No"}
       ,"Clinically Significant" : { DESC:"Clinically Significant", PASS_IND: "Yes"}
       ,"Acceptable" : { DESC:"Acceptable", PASS_IND: "Yes"}
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        if(row.getField("BIRTH_DATE")!==undefined && row.getField("BIRTH_DATE") !==null && row.getField("BIRTH_DATE").substring(2,3)==="-"){
            ...
            var birthDateObject = AppUtil.getDateObjByPattern(row.getField("BIRTH_DATE"), "M/d/yyyy");
        }
...
//            finalDate = AppUtil.getDateObjByPattern(row.getField("TEST_ADMIN_DATE"), "dd/MM/yyyy").STANDARD_DATE;
//        }
//        else{
//
...
//        }
    ...
    function mapScaledScore(row, testMetadata, rNumber) {
        var score = {};

        var testNumber = testMetadata.TEST + testMetadata.NUMBER + rNumber;

        var scaleScore = row.getField( "BASC3_R" + "_" + rNumber);
    ...
    function mapPerfScore(row, testMetadata, rNumber) {
        var score = {};

        var testNumber = testMetadata.TEST + testMetadata.NUMBER + rNumber + "_CAT";
        var perfLevel = row.getField( "BASC3_EDI" + "_" + rNumber);
    ...
    function mapPrimaryScore(row, testMetadata) {
        var score = {};

        var testNumber = testMetadata.TEST + testMetadata.CODE;
        var primaryTscore = row.getField(testMetadata.FIELD + "_T");


        // Check for key fields and do not map score and exit if conditions met.
        if((primaryTscore === null || primaryTscore === undefined || _util.trim(primaryTscore) === "--" || _util.trim(primaryTscore) === ""))
        {
            return null;
        }
        ...
        score["TEST_RAW_SCORE"] = primaryTscore;
    ...
    function mapCompositeScore(row, testMetadata) {
        ...
        var testNumber = testMetadata.TEST + testMetadata.CODE;
        var compositeTscore = row.getField(testMetadata.FIELD + "_T");

        // Check for key fields and do not map score and exit if conditions met.
        if((compositeTscore === null || compositeTscore === undefined || _util.trim(compositeTscore) === "--" || _util.trim(compositeTscore) === ""))
        {
            return null;
        }
        score["TEST_NUMBER"] = testNumber;

        if(compositeTscore != null){
        score["TEST_RAW_SCORE"] = compositeTscore;
        }
