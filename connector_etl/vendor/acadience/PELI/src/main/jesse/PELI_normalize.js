var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "PELI";
    ...
    var scoresToMap = [
        {TEST: "PELI", CODE:"ALPHA_KNOW", FIELD: "ALPHABET_KNOWLEDGE_", MAP_FUNCTION: mapRawScore}
        ,{TEST: "PELI", CODE:"VOC_ORAL_LANG", FIELD: "VOCAB_ORAL_LANGUAGE_", MAP_FUNCTION: mapRawScore}
        ,{TEST: "PELI", CODE:"COMPREHENSION", FIELD: "COMPREHENSION_", MAP_FUNCTION: mapRawScore}
        ,{TEST: "PELI", CODE:"PHON_AWR", FIELD: "PHONOLOGICAL_AWARENESS_", MAP_FUNCTION: mapRawScore}
        ,{TEST: "PELI", CODE:"LANG_INDEX", FIELD: "LANGUAGE_INDEX_", MAP_FUNCTION: mapRawScore}
        ,{TEST: "PELI", CODE:"COMPOSITE", FIELD: "COMPOSITE_", MAP_FUNCTION: mapRawScore}
    ];
    ...
    var passDecode = {
       ...
       ,"Pro" : "Yes"
       ,"Proficient" : "Yes"
       ,"At or Above Benchmark" : "Yes"
       ,"Below Benchmark" : "No"
       ,"Well Below Benchmark" : "No"
       ,"" : null
       ,null : null
      };
    /***********************************************************************************
    ...
    function mapRawScore(row, testMetadata) {
		...
		var rawLevel = row.getField(testMetadata.FIELD + "LEVEL");
    	...
    	score["TEST_PASSED_INDICATOR"] = passDecode[rawLevel];
    	score["TEST_RAW_SCORE"] = rawScore;
    	score["TEST_PRIMARY_RESULT_CODE"] = rawScore;
    	score["TEST_PRIMARY_RESULT"] = rawLevel;
