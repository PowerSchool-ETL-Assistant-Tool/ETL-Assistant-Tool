var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "DIBELS_8TH";
...
//                .execute_markII(AssessmentLoader.config.ENABLE_DEBUG, 200, 1, 100);
    ...
    ***************************************************************************/
    ...
    var strandsAndFields =
        [
            // DIBELS 8th STRANDS
            {TEST: "DIB8TH", STRAND: "TOT"    , FIELD: "COMPOSITE", SHORT:"COMPOSITE"},
            {TEST: "DIB8TH", STRAND: "LNF"    , FIELD: "LNF", SHORT:"LNF"},
            {TEST: "DIB8TH", STRAND: "PSF"    , FIELD: "PSF", SHORT:"PSF"},
            {TEST: "DIB8TH", STRAND: "WRF"    , FIELD: "WRF", SHORT:"WRF"}, //new
            {TEST: "DIB8TH", STRAND: "NWFCLS" , FIELD: "NWF-CLS", SHORT:"NWF"},
            {TEST: "DIB8TH", STRAND: "MAZERD" , FIELD: "MAZE_RD", SHORT:"MAZE"},
            {TEST: "DIB8TH", STRAND: "MAZECR" , FIELD: "MAZE_CR", SHORT:"MAZE"},
            {TEST: "DIB8TH", STRAND: "MAZEICR" , FIELD: "MAZE_ICR", SHORT:"MAZE"},
            {TEST: "DIB8TH", STRAND: "VOCABULARY" , FIELD: "VOCABULARY", SHORT:"VOCABULARY"},
            {TEST: "DIB8TH", STRAND: "SPELLING" , FIELD: "SPELLING", SHORT:"SPELLING"},
            {TEST: "DIB8TH", STRAND: "RAN" , FIELD: "RAN", SHORT:"RAN"},
            {TEST: "DIB8TH", STRAND: "RISKIND" , FIELD: "RISK_INDICATOR", SHORT:"RISK_INDICATOR"},
            {TEST: "DIB8TH", STRAND: "NWFWRC" , FIELD: "NWF-WRC", SHORT:"NWF"}, //new
            {TEST: "DIB8TH", STRAND: "ORFWC" , FIELD: "ORF-WORDSCORRECT", SHORT:"ORF"}, //renamed from DORF
            {TEST: "DIB8TH", STRAND: "ORFWINC" , FIELD: "ORF-WORDSINCORRECT", SHORT:"ORF"},
            {TEST: "DIB8TH", STRAND: "ORFERR", FIELD: "ORF-ERRORS", SHORT:"ORF"}, //renamed from DORF
            {TEST: "DIB8TH", STRAND: "ORFACC", FIELD: "ORF-ACCURACY", SHORT:"ORF"}, //renamed from DORF
            {TEST: "DIB8TH", STRAND: "MAZECOR", FIELD: "MAZE-CORRECT", SHORT:"MAZE"}, //renamed from DAZE
            {TEST: "DIB8TH", STRAND: "MAZEINC", FIELD: "MAZE-INCORRECT", SHORT:"MAZE"}, //renamed from DAZE
            {TEST: "DIB8TH", STRAND: "MAZEADJ", FIELD: "MAZE-ADJUSTED", SHORT:"MAZE"}, //renamed from DAZE
            {TEST: "DIB8TH", STRAND: "GRGOAL", FIELD: "GROWTH_GOAL", SHORT:"GROWTH_GOAL"}, //renamed from DAZE
            {TEST: "DIB8TH", STRAND: "ORFFLU", FIELD: "ORF-FLUENCY", SHORT:"ORF"}
        ];
    ...
    var perfLevels =
        {
            "Intensive Support": {
                ...
                TEST_QUATERNARY_RESULT_CODE: "AR",
                TEST_QUATERNARY_RESULT: "At Risk"
            },
            "Strategic Support": {
                ...
                TEST_QUATERNARY_RESULT_CODE: "SR",
                TEST_QUATERNARY_RESULT: "Some risk"
            },
            "Core Support": {
                ...
                TEST_QUATERNARY_RESULT_CODE: "MR",
                TEST_QUATERNARY_RESULT: "Minimal risk"
            },
            "Core^ Support": {
                ...
                TEST_SECONDARY_RESULT_CODE: "AB",
                TEST_SECONDARY_RESULT: "At Or Above Benchmark",
                TEST_QUATERNARY_RESULT_CODE: "NR",
                TEST_QUATERNARY_RESULT: "Negligible risk"
            },
            "--": {
    ...
    ***********************************************************************************/
    ...
    function mapNormalizedRecords(signature, hierarchy, rows) {
        ...
        gradeLevels.forEach(function(gradeLevel) {
            if (row.getField("YEAR_${gradeLevel.FIELD}") !== null && row.getField("YEAR_${gradeLevel.FIELD}") !== "") {
               ...
               if(signature.getFormat().getFormatName() !== "DIBELS_8TH_FULL_105C"){
                    ...
                    if(gradeDecode[row.getField("ASSESSMENT_GRADE")]===gradeLevel.GRADE_CODE){//TODO
    ...
    function mapSingleNormalizedRecord(signature, hierarchy, row, gradeLevel, year, assessPeriod,assessPeriodIndex) {
        ...
        strandsAndFields.forEach(function(strandsAndField) {
                ...
                mappingObject.SCORE_MAPPINGS.push(
                    {
                        ...
                        "TEST_SCORE_VALUE" : score.replace("%", ''),
                        ...
                        "TEST_QUATERNARY_RESULT" : perfLevels[performanceCode].TEST_QUATERNARY_RESULT,
                        "TEST_QUATERNARY_RESULT_CODE" : perfLevels[performanceCode].TEST_QUATERNARY_RESULT_CODE,
            ...
            //DIB8TH##ENDGRGOAL test number format
            //Outcome is currently unknown value so is disabled
                ...
                }else if(goalSigName === "DIBELS_8TH_FULL_105C"){
                            ...
                            mappingObject.SCORE_MAPPINGS.push(
                                {
                                    ...
                                    "TEST_SCORE_VALUE" : parseInt(score.replace("%", '')),
                                    ...
                                    "TEST_GRADE_EQUIVALENT" : gradeDecode[row.getField("ASSESSMENT_GRADE")],
                                   // "TEST_SCORE_ATTRIBUTES" : type + " - " + dateField
                                }
                            );
                            }
                ...
                } else if(goalSigName === "DIBELS_8TH_21_COLS"){

                            var data = getResultAndDate(signature, row, year);
                            if(data.result.DESC == "BOY" && record.ASSESSMENT_ADMIN_KEY.toString().indexOf("_BEGINNING")<=0)
                            {
                                return null;
                            }
                            if(data.result.DESC == "MOY" && record.ASSESSMENT_ADMIN_KEY.toString().indexOf("_MIDDLE")<=0)
                            {
                                return null;
                            }
                            if(data.result.DESC == "EOY" && record.ASSESSMENT_ADMIN_KEY.toString().indexOf("_END")<=0)
                            {
                                return null;
                            }
                            
                            var testNumber = "${strandsAndField.TEST}${strandsAndField.STRAND}${data.result.DESC}${data.assessGrade}";
                            var lnf = row.getField("${strandsAndField.FIELD}_SCORE1");
                            var psf = row.getField("${strandsAndField.FIELD}_SCORE2");
                            var nwfCls = row.getField("${strandsAndField.FIELD}_SCORE3");
                            var nwfWrc = row.getField("${strandsAndField.FIELD}_SCORE4");
                            var wrf = row.getField("${strandsAndField.FIELD}_SCORE5");
                            var orfWordCorrect = row.getField("${strandsAndField.FIELD}_SCORE6");
                            var orfWordIncorrect = row.getField("${strandsAndField.FIELD}_SCORE7");
                            var mazeCorrect = row.getField("${strandsAndField.FIELD}_SCORE8");
                            var mazeInCorrect = row.getField("${strandsAndField.FIELD}_SCORE9");

                        if((lnf === null || lnf === undefined || _util.trim(lnf) === "--" || _util.trim(lnf) === "") &&
                           (psf === null || psf === undefined || _util.trim(psf) === "--" || _util.trim(psf) === "") &&
                           (nwfCls === null || nwfCls === undefined || _util.trim(nwfCls) === "--" || _util.trim(nwfCls) === "") &&
                           (nwfWrc === null || nwfWrc === undefined || _util.trim(nwfWrc) === "--" || _util.trim(nwfWrc) === "") &&
                           (wrf === null || wrf === undefined || _util.trim(wrf) === "--" || _util.trim(wrf) === "") &&
                           (orfWordCorrect === null || orfWordCorrect === undefined || _util.trim(orfWordCorrect) === "--" || _util.trim(orfWordCorrect) === "") &&
                           (orfWordIncorrect === null || orfWordIncorrect === undefined || _util.trim(orfWordIncorrect) === "--" || _util.trim(orfWordIncorrect) === "") &&
                           (mazeCorrect === null || mazeCorrect === undefined || _util.trim(mazeCorrect) === "--" || _util.trim(mazeCorrect) === "") &&
                           (mazeInCorrect === null || mazeInCorrect === undefined || _util.trim(mazeInCorrect) === "--" || _util.trim(mazeInCorrect) === ""))
                            ...
                            mappingObject.SCORE_MAPPINGS.push(
                                {
                                    ...
                                    "TEST_SCORE_VALUE" : mazeCorrect,
                                    "TEST_SCALED_SCORE" : mazeInCorrect,
                                    "TEST_SCORE_TEXT" : orfWordCorrect,
                                    "TEST_ITEMS_ATTEMPTED" : orfWordIncorrect,
                                    "TEST_ITEMS_POSSIBLE" : wrf,
                                    "TEST_PERCENTILE_SCORE" : nwfWrc,
                                    "TEST_RAW_SCORE" : nwfCls,
                                    "TEST_NCE_SCORE" : psf,
                                    "TEST_QUARTILE_SCORE" : lnf,
                                }
                            );
                            }
                            catch(exception){
    ...
    ***********************************************************************************/
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row, gradeLevel, year, assessPeriod) {
        ...
        var schoolInfo = _util.coalesce(row.getField("SCHOOL_${gradeLevel.FIELD}"),row.getField("SCHOOL"),row.getField("DISTRICT_NAME"),"");

        var sigName = signature.getFormat().getFormatName();
        if(sigName.toString().indexOf("FULL")>-1 && sigName.toString().indexOf("DIBELS_8TH")>-1){
        ...
        var data = getResultAndDate(signature, row, year);
        var reportingPeriod = null;
        if (data && data.result !== undefined && data.result!==null) {
            reportingPeriod = data.result.DESC;
        }
        //var assessPeriod = getAssesssPeriod(row);
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "REPORTING_PERIOD":
                    record.REPORTING_PERIOD = _util.coalesce(reportingPeriod, benchmarkPeriod, getTEST_ADMIN_PERIOD(assessPeriod));
                    break;
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE = _util.coalesce(data ? data.date : null,getTEST_ADMIN_DATE_STR(assessPeriod, year,row));
                ...
                case "STUDENT_GRADE_CODE":
                    ...
                    record.STUDENT_GRADE_CODE = _util.coalesce(data ? data.assessGrade : null,newGrade);
                ...
                case "SCHOOL_VENDOR_ID":
                    record.SCHOOL_VENDOR_ID = _util.coalesce(schoolInfo,schoolCode,schoolName);
                    break;
                default:
        ...
        function getResultAndDate(signature,row, year) {
            var goalSigName = signature.getFormat().getFormatName();

            if (goalSigName === "DIBELS_8TH_21_COLS") {

                var assessGrade = gradeDecode[row.getField("GRADE")];


                var assessWindow = row.getField("ASSESS_WINDOW");
                var result;

                switch (assessWindow) {
                    case "BOY":
                        result = { DESC: "BOY", PERIOD_INDEX: "0" };
                        break;
                    case "MOY":
                        result = { DESC: "MOY", PERIOD_INDEX: "1" };
                        break;
                    case "EOY":
                        result = { DESC: "EOY", PERIOD_INDEX: "2" };
                        break;
                    default:
                        result = { DESC: null, PERIOD_INDEX: null };
                        break;
                }

                var date = null;
                if (row.getField('TESTDATE') !== null && row.getField('TESTDATE') !== "" && row.getField('TESTDATE') !== undefined) {
                    date = AppUtil.getMonthFollowedByDay(row.getField('TESTDATE')).STANDARD_DATE;
                } else {
                    switch (assessWindow) {
                        case "BOY":
                            date = "10/15/" + year;
                ...
                return { result: result, date: date, assessGrade: assessGrade };
            }
    ...
    function parseGrade(sigName, gradeLevel) {
        if(sigName === "DIBELS_8TH_FAYETTE_20_21_K_FALL" || sigName === "DIBELS_FULL" || sigName === "DIBELS_8TH_MIDDLE" || sigName === "DIBELS_1ST_22_23" || sigName === "DIBELS_3RD_22_23"
            ...
            || sigName === "DIBELS_K_BEG_32C" || sigName === "DIBELS_K_END_33C" || sigName === "DIBELS_K_MID_32C" || sigName === "DIBELS_FULL_1040_COLS"
            || sigName === "DIBELS_8TH_FULL_105C") {
    ...
    ***************************************************************************/
    ...
    function groupAssessmentByNaturalKey(signature, hierarchy, one, two, gradeLevel, assessPeriod) {
        ...
        try {
               ...
               var assessmentAdminKey_one = generateAssessmentAdminKey(signature, hierarchy, one, gradeLevel, assessPeriod);
               var assessmentAdminKey_two = generateAssessmentAdminKey(signature, hierarchy, two, gradeLevel, assessPeriod);
