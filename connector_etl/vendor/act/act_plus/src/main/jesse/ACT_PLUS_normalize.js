var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "act_plus";
    ...
    var scoresToMap = [
     { TEST: "ACT_PLUS", CODE: "_WR", FIELD: "WRITING", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_ENG", FIELD: "ENGLISH", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_MA", FIELD: "MATH", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_RD", FIELD: "READING", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_ELA", FIELD: "ELA", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_SCI", FIELD: "SCIENCE", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_COMP", FIELD: "COMPOSITE", MAP_FUNCTION: mapScaledScore },
     { TEST: "ACT_PLUS", CODE: "_STEM", FIELD: "STEM", MAP_FUNCTION: mapScaledScore }
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row, normalizedFile) {
        ...
        var testDateObj = getTestAdminDate(row, reportingPeriod, hierarchy);
    ...
    function getTestAdminDate(row, period, hierarchy) {
        var date = null;
        if(row.getField("TEST_DATE")){
            date = AppUtil.getMonthFollowedByDay(row.getField("TEST_DATE")).STANDARD_DATE;
        }else{
