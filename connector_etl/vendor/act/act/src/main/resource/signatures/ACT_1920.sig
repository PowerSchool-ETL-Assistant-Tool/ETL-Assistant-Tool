{
	...
	"format": {
		...
		"hasHeader": true,
		"formatName": "ACT_1920",
		"naturalKey": ["TEST_DATE", "STUDENT_FIRST_NAME", "STUDENT_MIDDLE_INITIAL", "STUDENT_LAST_NAME", "STUDENT_EXPANDED_BIRTHDATE_STR"],
		"fields": [{
				"physicalName": "ID_ACT",
				"otherPossibleNames": [],
			...
			},
			{
				...
				"fieldLength": 500,
				"expectedValues": ["Male","Female","Another Gender","Prefer not to respond"],
				"dataTypes": "STRING",
				"scale": null
			},
			{
			...
			},
			{
				...
				"fieldLength": 500,
				"expectedValues": ["Cell","Home","Other",""],
				"dataTypes": "STRING",
				"scale": null
			},
			{
			...
			},
			{
				...
				"fieldLength": 500,
				"expectedValues": ["Above proficiency","Below proficiency","Proficient","Unable to Calculate"],
				"dataTypes": "STRING",
				"scale": null
			},
			{
			...
			},
			{
				...
				"fieldLength": 500,
				"expectedValues": ["Full-time","Part-time",""],
				"dataTypes": "STRING",
				"scale": null
			},
			{
			...
			},
			{
				...
				"fieldLength": 500,
				"expectedValues": ["Fairly sure","Not sure","Very sure",""],
				"dataTypes": "STRING",
				"scale": null
			},
			{
