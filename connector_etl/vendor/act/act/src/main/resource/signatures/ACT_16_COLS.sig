{
  ...
  "format": {
    "@type": "Delimited",
    "formatName": "ACT_16_COLS",
    "quoteDelim": "\"",
    "fieldDelim": ",",
    "recordLength": "",
    "hasHeader": true,
    "naturalKey": ["STUDENT_VENDOR_ID", "TEST_DATE"],
    "fields": [
      {
      ...
      {
        "physicalName": "Last Updated (CT)",
        "otherPossibleNames": [],
        "logicalName": "LAST_DATE",
        "formatMask": null,
        "isFieldRequired": "N",
        "canBeNull": "Y",
        "fieldOffset": {
      ...
      {
        "physicalName": "ACT composite superscore",
        "otherPossibleNames": [],
        "logicalName": "COMPOSITE_SUPER_SCALED_SCORE",
        "formatMask": null,
        "isFieldRequired": "N",
        "canBeNull": "Y",
        "fieldOffset": {
