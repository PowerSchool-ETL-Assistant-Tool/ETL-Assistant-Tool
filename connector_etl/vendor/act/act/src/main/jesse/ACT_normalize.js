var AppNormalize = (function () {
    ...
    ***************************************************************************/
    ...
    var scoresToMap =
        [
            { TEST: "ACT", CODE: "ENWR", FIELD: "COMBINED_ENGLISH_WRITING", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "WR", FIELD: "WRITING", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "EN", FIELD: "ENGLISH", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "MA", FIELD: "MATH", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "RD", FIELD: "READING", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "SC", FIELD: "SCIENCE", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "TOT", FIELD: "COMPOSITE", MAP_FUNCTION: mapCompositeScore }
            , { TEST: "ACT", CODE: "ENUM", FIELD: "SUBSCORE_ENGLISH_USAGE_MECH", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "ENRS", FIELD: "SUBSCORE_ENGLISH_RHETORICAL_SKILLS", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "MAPA", FIELD: "SUBSCORE_MATH_ELEM_ALGEBRA", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "MAIA", FIELD: "SUBSCORE_MATH_ALGEBRA_CORD_GEOMETRY", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "MAGEO", FIELD: "SUBSCORE_MATH_PLANE_GEOMETRY_TRIG", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "RDSS", FIELD: "SUBSCORE_READING_SOCIAL_STUDIES", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "RDAL", FIELD: "SUBSCORE_READING_ARTS_LIT", MAP_FUNCTION: mapScaledScore }
            , { TEST: "ACT", CODE: "WRRDSGN", FIELD: "WRITING_SUBJECT_SCORE", MAP_FUNCTION: mapScaledScore }
            ...
            , { TEST: "ACT", CODE: "STEM", FIELD: "STEM", MAP_FUNCTION: mapScaledScore }
            ...
            , { TEST: "ACT", CODE: "MATH_FUNC", FIELD: "MATH_FUNCTIONS", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "MATH_GEO", FIELD: "MATH_GEOMETRY", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "MATH_STATPROB", FIELD: "MATH_STATISTICS_AND_PROBABILITY", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "MATH_IES", FIELD: "MATH_INTEGRATING_ESSENTIAL_SKILLS", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "MATH_MODEL", FIELD: "MATH_MODELING", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "READ_KID", FIELD: "READING_KEY_IDEAS_DETAILS", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "READ_CAS", FIELD: "READING_CRAFT_AND_STRUCTURE", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "READ_IKI", FIELD: "READING_INTEGRATION_OF_KNOWLEDGE_AND_IDEAS", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "SCI_ID", FIELD: "SCIENCE_INTERPRETATION_OF_DATA", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "SCI_SI", FIELD: "SCIENCE_SCIENTIFIC_INVESTIGATION", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "SCI_EMIER", FIELD: "SCIENCE_EVAL_OF_MODELS_INFERENCES_EXP_RESULTS", MAP_FUNCTION: mapRawScore }
            , { TEST: "ACT", CODE: "SUM", FIELD: "SUM_OF_SCALE_SCORES", MAP_FUNCTION: mapOverallScaledScore }
            , { TEST: "ACT", CODE: "TOTSUP", FIELD: "COMPOSITE_SUPER", MAP_FUNCTION: mapCompositeSuperScore }
        ];
    ...
    ***************************************************************************/
    ...
    var progressTowardCareerReadinessDecode = {
        ...
        , "Needs Improvement": "Insufficient progress toward an NCRC level"
        , "Bronze": "Progress toward Bronze Level NCRC"
        , "Silver": "Progress toward Silver level NCRC"
        , "Gold": "Progress toward Gold level NCRC"
        , "Platinum": "Progress toward Platinum level NCRC"
        , "-": "Unable to calculate"
    };
   ...
   var testLocDecode = {
     "ST" :  {NAME: "State", CODE: "S"}
     ,"S" :  {NAME: "State", CODE: "S"}
     ,"State" : {NAME: "State", CODE: "S"}
     ," " :  {NAME: "National", CODE: "N"}
     ,null : {NAME: "National", CODE: "N"}
   }
    ...
    ***********************************************************************************/
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        if (signature.getFormat().getFormatName() === "ACT_IREDELL_COMMON_16171819"){
        var testDateObject = '05/15/' + hierarchy.SCHOOL_YEAR.substring(5, 9);
        }
        var expandedDateObject = parseExpandedDate(row.getField("EXPANDED_TEST_DATE"));
        var birthDateObject = null;

        if (row.getField("STUDENT_EXPANDED_BIRTHDATE_STR") !== null) {
            birthDateObject = parseDate(row.getField("STUDENT_EXPANDED_BIRTHDATE_STR"));
        } else {
            birthDateObject = parseDate(row.getField("STUDENT_BIRTHDATE_STR"));
        }

       var studentStateCode = null;
       var stateCode = row.getField("STUDENT_STATE");
       if (stateCode != null){
        studentStateCode = _util.coalesce(row.getField("STUDENT_STATE")+ "-").substring(0, 2);
       }

       var studentGenderCode = null;
       var genderCode = row.getField("STUDENT_GENDER_CODE");
       if (genderCode != null){
       studentGenderCode = _util.trim(row.getField("STUDENT_GENDER_CODE") + "-").substring(0, 1);
       }

       var period = row.getField("ADMIN");
       if(period !== null && period !== undefined && period !== ""){
            var adminPeriod = period.toUpperCase();
       }
        ...
        normalizedFileFields.forEach(function (field) {
            switch (field) {
                ...
                case "SCHOOL_LOCAL_ID":
                     record.SCHOOL_LOCAL_ID = _util.coalesce(row.getField("ACT_DISTRICT_CODE"));
                     break;
                case "SCHOOL_STATE_ID":
                     record.SCHOOL_STATE_ID = _util.coalesce(row.getField("ACT_STATE_CODE"));
                     break;
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE = _util.coalesce(testDateObject.STANDARD_DATE, expandedDateObject.STANDARD_DATE, '05/15/' + hierarchy.SCHOOL_YEAR.substring(5, 9));
                    break;
                ...
                case "STUDENT_LOCAL_ID":
                    record.STUDENT_LOCAL_ID = _util.coalesce(row.getField("LOCAL_ID_NUMBER"), row.getField("LOCAL_ID"), row.getField("STUDENT_VENDOR_ID"));
                    break;
                ...
                case "STUDENT_STATE_CODE":
                    record.STUDENT_STATE_CODE = studentStateCode;
                    break;
                ...
                case "STUDENT_GRADE_CODE":
                    record.STUDENT_GRADE_CODE = gradeDecode[_util.coalesce(row.getField("GRADE_LEVEL"), row.getField("GRADE"), row.getField("STUDENT_GRADE_CODE"))];
                    break;
                case "TEST_LOCATION":
    ...
    function mapAdditionalAdminFields(row) {
        ...
        var testLocation = _util.trim(_util.coalesce(row.getField("TEST_LOCATION"),row.getField("TEST_LOCATIONS")));
        if (testLocation === "ST" || testLocation === "S" || testLocation === "State" || testLocation === null || testLocation === " ") {
            admin.TEST_INTERVENTION_DESC = testLocDecode[testLocation].NAME;
            admin.TEST_INTERVENTION_CODE = testLocDecode[testLocation].CODE;
        }
        return admin;
    }
    ...
    ***********************************************************************************/
    ...
    function mapCompositeScore(row, testMetadata) {
		...
		var stateRank = row.getField(testMetadata.FIELD + "_STATE_RANKS");
        ...
        if (careerReadinessCode !== "-") {
            score["TEST_PRIMARY_RESULT_CODE"] = careerReadinessCode;
        }
        if (stateRank !== "" && stateRank !== undefined && stateRank !== "---" && stateRank !== "--") {
            score["TEST_NCE_SCORE"] = stateRank;
        }
    ...
    function mapScaledScore(row, testMetadata, signature) {
        ...
        if(sigName === "ACT_STUDENT_RECORD_1721" || sigName === "ACT_23_135_COLS"){
            score["TEST_PRIMARY_RESULT_CODE"] = perfCode[row.getField(testMetadata.FIELD + "_BENCHMARK")];
            score["TEST_PRIMARY_RESULT"] = perfLevels[row.getField(testMetadata.FIELD + "_BENCHMARK")];
        }
        return score;
    }
    ...
    function mapELAScore(row, testMetadata, signature) {
        var score = {};
    ...
    function mapCompositeSuperScore(row, testMetadata, signature) {
            var score = {};
    ...
    ***************************************************************************/
    ...
    function generateAssessmentAdminKey(signature, hierarchy, srcRecord) {
        ...
        var testDateObject = module.mapDateObject(hierarchy, srcRecord, srcRecord.getField("TEST_DATE"));
        var birthDate = parseDate(srcRecord.getField("STUDENT_BIRTHDATE_STR"));
        var signatureFormatName = signature.getFormat().getFormatName();

        if (signatureFormatName === 'ACT_2020_2021' || signatureFormatName === 'ACT_2021_ALT' && testDateObject !== null && testDateObject !== undefined) {
            assessmentAdminKey += "_" + testDateObject.STANDARD_DATE;
        }
        if (signatureFormatName === 'ACT_2021_ALT' && birthDate !== null && birthDate !== undefined) {
            assessmentAdminKey += "_" + birthDate.STANDARD_DATE;
        }
        ...
        //Special case for really weird files such as Scrubbed_ACT_Scores_MARION.csv where only local ID is present
        if(signatureFormatName === "ACT_2021_ALT" && srcRecord.getField("STUDENT_FIRST_NAME")===null){
            assessmentAdminKey = assessmentAdminKey + "_" + srcRecord.getField("LOCAL_ID_NUMBER");
        }
    ...
    function parseDate(rawDate) {
        ...
        if ((rawDate.length >= 8) && (rawDate.length <= 10) && (rawDate.indexOf("/") > -1) && (rawDate.split('/')[2].length === 4))
        {
            var formatter = new java.text.SimpleDateFormat("MM/dd/yyyy");

        }
        else if ((rawDate.indexOf("/") > -1) && (rawDate.length === 7) && (rawDate.split('/')[2].length === 2))
        {
            var formatter = new java.text.SimpleDateFormat("M/dd/yy");
        }
        else if (rawDate.length === 8 && (rawDate.indexOf("/") > -1) && (rawDate.split('/')[2].length === 2))
        {
            var formatter = new java.text.SimpleDateFormat("MM/dd/yy");
        }
        else if (rawDate.length === 10 && rawDate.indexOf("-") === 2)
        {
        ...
        else if (rawDate.length === 8 && rawDate[4] === "1") // This condition works for 20th century
        {
            var formatter = new java.text.SimpleDateFormat("MMddyyyy");
        }
        ...
        {
            var formatter = new java.text.SimpleDateFormat("M/d/yy");
        }
    ...
    module.mapDateObject = function(hierarchy, row, dateStr) {
        ...
        if(testDateObject === null){
            try {
                testDateObject = AppUtil.getDateObjByPattern(dateStr, "yy-MMM");
            } catch(exception){
                // Error will be reported in final check.
            }
        }
        ...
        if(testDateObject === null){
            try {
                testDateObject = AppUtil.getDateObjByPattern(dateStr, "MMM-yy");
            } catch(exception){
                // Error will be reported in final check.
            }
        }
        ...
        if(testDateObject === null){
            try {
                testDateObject = AppUtil.getDateObjByPattern(dateStr, "MMyyyy");
            } catch(exception){
                // Error will be reported in final check.
            }
        }
        ...
        if(testDateObject === null){
            try {
                testDateObject = AppUtil.getDateObjByPattern(dateStr, "MMyy");
            } catch(exception){
                // Error will be reported in final check.
            }
        }
        if(testDateObject === null){
            try {
                 testDateObject = AppUtil.getDateObjByPattern(dateStr, "Mddyy");
             } catch(exception){
                // Error will be reported in final check.
            }
        }
//        if(testDateObject === null){
//            try {
//                testDateObject = AppUtil.getDateObjByPattern(dateStr, "Myy");
//                print("Test Date case Myy\n");
//            } catch(exception){
//                // Error will be reported in final check.
//            }
//        }
        ...
        if(testDateObject === null){
            ...
            if (testDateObject.MONTH !== null && testDateObject.MONTH.length === 1) {
                testDateObject.MONTH = `0${testDateObject.MONTH}`;
            }
            if (testDateObject.YEAR && testDateObject.YEAR.length === 2) {
                testDateObject.YEAR = `20${testDateObject.YEAR}`;
            }
    ...
    function parseExpandedDate(rawDate) {
        ...
        {
            var formatter = new java.text.SimpleDateFormat("yyyyMMdd");
            rawDate = rawDate + "15";//Default day added on
        }
        else {
            var formatter = new java.text.SimpleDateFormat("MM/dd/yyyy");
        }
