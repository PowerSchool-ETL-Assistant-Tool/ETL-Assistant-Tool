var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "ATLAS";
     ...
     ***************************************************************************/
    var scoresToMap = [
        {TEST: "ATLAS_ESPANOL", CODE:"TTRCOT", FIELD: "", MAP_FUNCTION: mapOverallScore}
    ];
    ...
    function mapOverallScore(row, testMetadata) {
        try {
            ...
            testNumber = testMetadata.TEST + "_" + row.getField("BENCHMARK_PERIOD");
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var birthDateObject = {
         ...
         var testDateField = row.getField("SYNC_DATE");
         var testDateObject = {
                                   RAW_DATE : null
                                   , MONTH : null
                                   , DAY : null
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "STUDENT_VENDOR_ID":
                    record.STUDENT_VENDOR_ID = _util.coalesce(row.getField("STUDENT_PRIMARY_ID"));
                    break;
