var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "DIBELS_PROG_MON";
    ...
    var strandsAndFields =
        [
            ...
            // DIBELS NEXT STRANDS
            {TEST: "DIBELS", STRAND: "PROGMON", FIELD: "PROGMON"}
        ];
    ...
    ***********************************************************************************/
    ...
    function mapSingleNormalizedRecord(signature, hierarchy, row, year) {
        ...
        strandsAndFields.forEach(function(strandsAndField) {
            ...
            var clientDate = AppUtil.getDateObjByPattern(row.getField("CLIENT_DATE"), "MM/dd/yyyy").STANDARD_DATE;
            var syncDate = AppUtil.getDateObjByPattern(row.getField("SYNC_DATE"), "MM/dd/yyyy").STANDARD_DATE;

            mappingObject.SCORE_MAPPINGS.push(
                {
                "TEST_NUMBER" : "DIBELS_" + gradeLevels[row.getField("ASSESSMENT_GRADE")] + "_" + getShortAdminPeriod(row.getField("PM_PERIOD")) + "_" +measure + "_PROGMON",
    ...
    ***************************************************************************/
    ...
    function generateAssessmentAdminKey(signature, hierarchy, srcRecord) {
        ...
        var clientDate = AppUtil.getDateObjByPattern(srcRecord.getField("CLIENT_DATE"), "MM/dd/yyyy").STANDARD_DATE;
