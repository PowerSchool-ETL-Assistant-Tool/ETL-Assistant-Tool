var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "G9_MATH";
    ...
    var scoresToMap = [
        {TEST: "ON_G9_MATH", CODE:"OVR", FIELD: "OVERALL_", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var birthDateObject = AppUtil.getDateObjByPattern(row.getField("STUDENT_BIRTHDATE"), "yyyyMMdd");
            ...
            // Check for ADMINISTRATION field and calculate testDate accordingly
            ...
            if (period) {
                ...
                reportingPeriod = period;  // Use the actual period if it exists
            }
            ...
            normalizedFileFields.forEach(function (field) {
                switch(field) {
                    ...
                    case "STUDENT_LOCAL_ID":
                        record.STUDENT_LOCAL_ID = _util.coalesce(row.getField("STUDENTOEN"));
                        break;
