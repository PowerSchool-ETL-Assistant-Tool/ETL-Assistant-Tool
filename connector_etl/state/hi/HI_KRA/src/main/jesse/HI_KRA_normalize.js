var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "HI_KRA";
    ...
    var scoresToMap = [
            {TEST: "HI_KRA_", CODE:"MATH_", FIELD: "MA_", NAME: "MATHEMATICS", MAP_FUNCTION: mapScaledScore}
            ,{TEST: "HI_KRA_", CODE:"SOCIAL_", FIELD: "SF_", NAME: "SOCIAL_FOUNDATION", MAP_FUNCTION: mapScaledScore}
            ,{TEST: "HI_KRA_", CODE:"LANGUAGE_LITERACY_", FIELD: "LL_", NAME: "LANGUAGE_AND_LITERACY", MAP_FUNCTION: mapScaledScore}
            ,{TEST: "HI_KRA_", CODE:"PHYSICAL_MOTOR_", FIELD: "PD_", NAME: "PHYSICAL_WELL_BEING_AND_MOTOR_DEVELOPMENT", MAP_FUNCTION: mapScaledScore}
            ,{TEST: "HI_KRA_", CODE:"OVR_", FIELD: "OVERALL_", NAME: "OVERALL", MAP_FUNCTION: mapScaledScore}
        ];
        ...
        var passInd = {
            "Demonstrating Readiness" : "No"
            ,"Approaching Readiness" : "No"
            ,"Emerging Readiness" : "Yes"
            ,"" : null
            ,null : null
        };
