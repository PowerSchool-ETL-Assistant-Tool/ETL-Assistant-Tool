var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "SRSS_IE";
    ...
    var scoresToMap = [
        {TEST: "SRSS_IE", CODE:"_INT", FIELD: "INTERNALIZING_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "SRSS_IE", CODE:"_EXT", FIELD: "EXTERNALIZING_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "SRSS_IE", CODE:"_OVR", FIELD: "OVERALL_", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var getTAP = row.getField("SEASON");
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "SCHOOL_LOCAL_ID":
                     record.SCHOOL_LOCAL_ID = _util.coalesce(row.getField("SCHOOL_NUMBER"), row.getField("SCHOOL_LOCAL_ID"),row.getField("SCHOOL_STATE_ID"), row.getField("SCHOOL_NAME"));
                     break;
                case "SCHOOL_STATE_ID":
                     record.SCHOOL_STATE_ID = _util.coalesce(row.getField("SCHOOL_NUMBER"), row.getField("SCHOOL_LOCAL_ID"),row.getField("SCHOOL_STATE_ID"), row.getField("SCHOOL_NAME"));
                     break;
    ...
    function mapScaledScore(row, testMetadata) {
		...
		var riskLevel = row.getField(testMetadata.FIELD + "RISK_LEVEL");
    	...
    	score["TEST_PASSED_INDICATOR"] = passDecode[riskLevel];
    	score["TEST_PRIMARY_RESULT_CODE"] = primaryDecode[riskLevel];
    	score["TEST_PRIMARY_RESULT"] = riskLevel;
