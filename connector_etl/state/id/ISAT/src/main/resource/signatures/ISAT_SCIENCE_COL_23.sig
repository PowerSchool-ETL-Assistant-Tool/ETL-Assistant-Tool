{
  ...
  "format": {
    "@type": "Delimited",
    "formatName": "ISAT_SCIENCE_COL_23",
    "quoteDelim": "\"",
    "fieldDelim": ",",
    "recordLength": "",
    "hasHeader": true,
    "naturalKey": ["STUDENT_ID","TEST_NAME"],
    "fields": [
      {
      ...
      },
      {
        ...
        "logicalName": "SECTION_504_STATUS_",
        "formatMask": null,
        "isFieldRequired": "Y",
        "canBeNull": "Y",
        "fieldOffset": {
      ...
      },
      {
        ...
        "otherPossibleNames": ["Race/Ethnicity"],
      ...
      {
        "physicalName": "Scale Score Standard Error",
        "otherPossibleNames": [],
