var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "CIVICS";
    ...
    var scoresToMap = [
        {TEST: "CIVICS", CODE:"OVR", FIELD: "OVERALL_", MAP_FUNCTION: mapScaledScore}
    ];
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "SCHOOL_LOCAL_ID":
                     record.SCHOOL_LOCAL_ID = _util.coalesce(row.getField("DISTRICT_NUMBER"));
                     break;
                case "SCHOOL_STATE_ID":
                     record.SCHOOL_STATE_ID = _util.coalesce(row.getField("SCHOOL_NUMBER"));
                     break;
                case "SCHOOL_NAME":
                     record.SCHOOL_NAME = _util.coalesce(row.getField("SCHOOL_NUMBER"));
                     break;
...
//        if(passInd === null || passInd === undefined || _util.trim(passInd) === "--" || _util.trim(passInd) === "NULL" || passInd === "")
//         {
//            return null;
//        }
    	...
    	score["TEST_PRIMARY_RESULT"] = passInd;
    	score["TEST_PRIMARY_RESULT_CODE"] = passDecode[passInd];
