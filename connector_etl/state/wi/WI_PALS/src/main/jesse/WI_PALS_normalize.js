var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "WI_PALS";
    ...
    var scoresToMap = [
        {TEST: "WI_PALS", CODE:"NWR", FIELD: "NAME_WRITING", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"UCA", FIELD: "UC_ALPHABET", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"LCA", FIELD: "LC_ALPHABET", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"LS", FIELD: "LETTER_SOUNDS", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"BSA", FIELD: "BEG_SOUND_AWARENESS", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"PWA", FIELD: "PRINT_WORD_AWARENESS", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"RHYA", FIELD: "RHYME_AWARENESS", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "WI_PALS", CODE:"NRHYA", FIELD: "NURSERY_RHYME_AWARENESS", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var birthDate = _util.coalesce(row.getField("BIRTHDAY"));
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "REPORTING_PERIOD":
                    record.REPORTING_PERIOD = periodDecode[row.getField("SEMESTER")];
                    break;
    ...
    function mapScaledScore(row, testMetadata) {
        var score = {};
        var testNumber = testMetadata.TEST + "_" + testMetadata.CODE + "_" + row.getField("ASSESSMENT_TYPE");
