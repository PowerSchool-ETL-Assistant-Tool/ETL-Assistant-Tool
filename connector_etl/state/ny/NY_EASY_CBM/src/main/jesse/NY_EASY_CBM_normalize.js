var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "NY_EASY_CBM";
...
//    };
    ...
    var scoresToMap = [
        {TEST: "NY_EASY_CBM", CODE:"RDG_BASIC_3", FIELD: "RDG_BASIC_3_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"RDG_BASIC_4", FIELD: "RDG_BASIC_4_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"RDG_BASIC_5", FIELD: "RDG_BASIC_5_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"RDG_PROF_2", FIELD: "RDG_PROF_2_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"RDG_PROF_3", FIELD: "RDG_PROF_3_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"RDG_PROF_4", FIELD: "RDG_PROF_4_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"RDG_PROF_5", FIELD: "RDG_PROF_5_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"LN_K", FIELD: "LN_K_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"LN_1", FIELD: "LN_1_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"LS_1", FIELD: "LS_1_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"LS_K", FIELD: "LS_K_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PRF_1", FIELD: "PRF_1_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PRF_2", FIELD: "PRF_2_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PRF_3", FIELD: "PRF_3_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PRF_4", FIELD: "PRF_4_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PRF_5", FIELD: "PRF_5_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PS_1", FIELD: "PS_1_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"PS_K", FIELD: "PS_K_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"VOCAB_2", FIELD: "VOCAB_2_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"WRF_K", FIELD: "WRF_K_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"WRF_1", FIELD: "WRF_1_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"WRF_2", FIELD: "WRF_2_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "NY_EASY_CBM", CODE:"WRF_3", FIELD: "WRF_3_", MAP_FUNCTION: mapScaledScore}
    ];
    ...
    function mapScaledScore(row, testMetadata, i) {
        var score = {};
        var testNumber = testMetadata.TEST + "_" + testMetadata.CODE + "_" + i;
        var scaleScore = row.getField(testMetadata.FIELD + i + "_SCORE");
        var roi = row.getField(testMetadata.FIELD + i + "_ROI");
        var testDates = row.getField(testMetadata.FIELD + i + "_DATE");
        if(testDates){
        testDates = AppUtil.getMonthFollowedByDay(testDates).STANDARD_DATE;
        }
        ...
        score["TEST_SCORE_ATTRIBUTES"] = testDates;
    	score["TEST_PRIMARY_RESULT_CODE"] = roi;
