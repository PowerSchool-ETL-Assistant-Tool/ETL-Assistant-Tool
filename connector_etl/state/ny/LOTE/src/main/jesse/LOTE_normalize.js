var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "LOTE";
    ...
    var scoresToMap = [
        {TEST: "LOTE", CODE:"_ELA_OVR", FIELD: "ELA", MAP_FUNCTION: mapScaledScore}
    ...
    function mapScaledScore(row, testMetadata) {
        ...
        if(scaleScore === undefined || _util.trim(scaleScore) === "--" ) {
            return null;
        }

    	// Set score fields
    	score["TEST_NUMBER"] = testNumber;
    	score["TEST_SCORE_TEXT"] = row.getField("ALPHA_SCORE");
        if(!isNaN(scaleScore)){
