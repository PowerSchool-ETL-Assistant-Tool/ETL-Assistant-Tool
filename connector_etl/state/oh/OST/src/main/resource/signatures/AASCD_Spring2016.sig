{
    ...
    "format": {
        "@type": "Delimited",
        "formatName": "AASCD_Spring2016",
        "quoteDelim": "\"",
        "fieldDelim": ",",
        "recordLength": "",
        "hasHeader": true,
        "naturalKey": ["STUDENT_STATE_ID","STUDENT_FIRST_NAME", "STUDENT_MIDDLE_NAME", "STUDENT_LAST_NAME"],
        "fields": [
            {
            ...
            {
                "physicalName": "PBA tested",
                "otherPossibleNames": [],
                "logicalName": "PBA_TESTED",
                "formatMask": null,
                "isFieldRequired": "Y",
                "canBeNull": "Y",
                "fieldOffset": {
            ...
            {
                "physicalName": "EOY tested",
                "otherPossibleNames": [],
                "logicalName": "EOY_TESTED",
                "formatMask": null,
                "isFieldRequired": "Y",
                "canBeNull": "Y",
                "fieldOffset": {
