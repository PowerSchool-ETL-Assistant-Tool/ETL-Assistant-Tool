...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/IMAGINE_LEARNING_LANGUAGE_LITERACY_normalize.js");
    ...
    AppConnectorTest.QUnit.test("IMAGINE_LEARNING_LANGUAGE_LITERACY TESTS", function (assert) {
