var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MN_ACCESS_EARLY_REPORT";
    ...
    var scoresToMap =
        [
            //Access
              {TEST: "ACC", CODE: "OVERALL_SCORE", CODE2: "PLSC", NUM_PART: "TOT", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "COMPREHENSION", CODE2: "PLSO", NUM_PART: "COMP", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "LITERACY", CODE2: "PLSL", NUM_PART: "LIT", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "ORAL", CODE2: "", NUM_PART: "ORAL", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "LISTENING", CODE2: "", NUM_PART: "LIS", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "READING", CODE2: "", NUM_PART: "RD", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "SPEAKING", CODE2: "", NUM_PART: "SP", MAP_FUNCTION: mapAccessStrandScore}
              ,{TEST: "ACC", CODE: "WRITING", CODE2: "", NUM_PART: "WR", MAP_FUNCTION: mapAccessStrandScore}
        ];
    ...
    function mapNormalizedRecords(signature, hierarchy, rows) {
        //print(multipleRowsPerGroupingExpected);
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var testDateObject = parseDate("12/01/"+(row.getField("TEST_DATE")-1));
    ...
    function mapAccessStrandScore(row, testMetadata){
        ...
        var scoreValue = trimZeroes(row.getField(testMetadata.CODE+"_SCALE_SCORE"));
        if(scoreValue === undefined || scoreValue === null || _util.trim(scoreValue) === "") {
            return null;
        }
        var pass = row.getField("MN_PROFICIENCY_FOR_ACCESS_FOR_ELLS");
        score["TEST_PRIMARY_RESULT_CODE"] = trimZeroes(row.getField(testMetadata.CODE+"_PROFICIENCY_LEVEL"));
        score["TEST_PRIMARY_RESULT"] = decodeProficiencyLevel(row.getField(testMetadata.CODE+"_PROFICIENCY_LEVEL"));
        var formNumber = row.getField("FORM_NUMBER");
        // Set score fields
        ...
        if(testMetadata.NUM_PART==="TOT"){
            score["TEST_PASSED_INDICATOR"] = trimZeroes(pass);
        }
        score["TEST_SCORE_ATTRIBUTES"] = "Preliminary";
        return score;
    }
    /***************************************************************************
     Utility Functions
    ...
    function parseDate(rawDate) {
        ...
        if(_util.trim(_util.coalesce(rawDate, "")) === ""||rawDate ===null) {
            dateObj.RAW_DATE = "";
            return dateObj;
        }
