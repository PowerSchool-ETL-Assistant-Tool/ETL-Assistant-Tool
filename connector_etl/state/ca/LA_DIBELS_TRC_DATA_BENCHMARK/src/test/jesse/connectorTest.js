...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/LA_DIBELS_TRC_DATA_BENCHMARK_normalize.js");
    ...
    AppConnectorTest.QUnit.test("LA_DIBELS_TRC_DATA_BENCHMARK TESTS", function (assert) {
