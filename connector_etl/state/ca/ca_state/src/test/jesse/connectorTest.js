...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/CA_STATE_normalize.js");
    ...
    AppConnectorTest.QUnit.test("CA_STATE TESTS", function (assert) {
    ...
    AppConnectorTest.QUnit.test("CA_STATE DATE TRANSFORMATION TESTS", function (assert) {
