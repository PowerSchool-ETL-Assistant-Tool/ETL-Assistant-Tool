...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/CAASPP_INTERIM_AND_SUMMATIVE_normalize.js");
    ...
    AppConnectorTest.QUnit.test("CAASPP_INTERIM_AND_SUMMATIVE TESTS", function (assert) {
