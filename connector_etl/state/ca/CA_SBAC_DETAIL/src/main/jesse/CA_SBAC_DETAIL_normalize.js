var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "CA_SBAC_DETAIL";
    ...
    var scoresToMap = [
        {TEST: "CA_SBAC_DETAIL_", CODE:"ELA", FIELD: "", SUBIND: "ELA", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"ELARD", SUBIND: "ELA", FIELD: "READING", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"ELALIS", SUBIND: "ELA", FIELD: "LISTENING", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"ELAWR", SUBIND: "ELA", FIELD: "WRITING_AND_RESEARCH", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"MA", SUBIND: "MATH", FIELD: "", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"SCI", SUBIND :"", FIELD: "", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"MACR", SUBIND: "MATH", FIELD: "COMMUNICATING_REASONING", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"MACP", SUBIND: "MATH", FIELD: "CONCEPTS_AND_PROCEDURES", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"MAPSMDA", SUBIND: "MATH", FIELD: "PROBLEM_SOLVING", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"SCIES", SUBIND: "", FIELD: "EARTH/SPACE_SCIENCES", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"SCILS", SUBIND: "", FIELD: "LIFE_SCIENCES", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"SCIPS", SUBIND: "", FIELD: "PHYSICAL_SCIENCES", MAP_FUNCTION: mapStrandScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"IAB", SUBIND: "", FIELD: "", MAP_FUNCTION: mapIABScore}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"ELA", SUBIND: "ELA", FIELD: "COMPOSITE_CLAIM_1", MAP_FUNCTION: mapClaimScores}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"ELA", SUBIND: "ELA", FIELD: "COMPOSITE_CLAIM_2", MAP_FUNCTION: mapClaimScores}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"MATH", SUBIND: "MATH", FIELD: "COMPOSITE_CLAIM_1", MAP_FUNCTION: mapClaimScores}
        ,{TEST: "CA_SBAC_DETAIL_", CODE:"MATH", SUBIND: "MATH", FIELD: "COMPOSITE_CLAIM_2", MAP_FUNCTION: mapClaimScores}
    ];
    ...
    var performanceLevelDecode = {
                    ...
                    ,"--" : {CODE: null, DESC: null, PASS_IND: null}
                    , "9" : {CODE: null, DESC: null, PASS_IND: null}
                    };
    /***********************************************************************************
    ...
    function mapNormalizedRecords(signature, hierarchy, rows) {
        ...
        var subjects = ["ELA", "MATH"]; // Predefined subjects

        subjects.forEach(function(subject) {
        if(row.getField(subject + "_ATTEMPT_FLAG")){
            // Map normalized records for the current subject
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE = _util.coalesce((AppUtil.getDateObjByPattern(lasttestdate, "yyyy-MM-dd").STANDARD_DATE),(AppUtil.getDateObjByPattern(row.getField("TEST_ADMIN_DATE"), "MM/dd/yyyy").STANDARD_DATE));
                    break;

                //Student Information
                case "STUDENT_LOCAL_ID":
                    record.STUDENT_LOCAL_ID = _util.coalesce(row.getField("DISTID"), row.getField("SASID"));
                    break;
                case "STUDENT_STATE_ID":
                    record.STUDENT_STATE_ID = _util.coalesce(row.getField("SASID"));
                    break;
                case "STUDENT_VENDOR_ID":
                    record.STUDENT_VENDOR_ID = _util.coalesce(row.getField("DISTID"), row.getField("SASID"));
                    break;
                ...
                case "SCHOOL_STATE_ID":
                     record.SCHOOL_STATE_ID = row.getField("SCHOOL_CODE");
                     break;
    ...
    function mapScaledScore(row, testMetadata, subj) {
            ...
            else
            {
               ...
               var testedGrade = gradeDecode[row.getField(testMetadata.CODE + "_GRADE_TESTED")];
            }
            ...
            if(performanceLevelDescription === "9"){
                return null;
            }
            ...
            if(performanceLevelDescription!== undefined || performanceLevelDescription!== null){
        ...
        function mapStrandScore(row, testMetadata, subj){
            var score = {};
    ...
    function mapIABScore (row, testMetadata, subj) {
               var score = {};
               ...
               if(achlevel!== undefined || achlevel !== null){
    ...
    function mapClaimScores(row, testMetadata, subj){
        score = {};
        ...
        var testNumber = testMetadata.TEST + testMetadata.CODE + "_" + testMetadata.FIELD;
        var scaledScore = row.getField((testMetadata.CODE + "_" + testMetadata.FIELD + "_SCR"));
        var sbaClaimAchieveLvl = row.getField((testMetadata.CODE + "_" + testMetadata.FIELD + "_LVL"));

        //basic scaled score validation
        if((scaledScore === null || scaledScore === undefined || _util.trim(scaledScore) === "--" || _util.trim(scaledScore) === "" || scaledScore === "Insufficient to score" || scaledScore === "Invalidated" )) {
            return null;
        }
    ...
    function generateAssessmentAdminKey(signature, hierarchy, srcRecord) {
        ...
        var lastTestDateTime = srcRecord.getField("LAST_TEST_DATE");
        ...
        //restructured post normalization req - UIHN 81154
         /*var finalDate1 = null;
