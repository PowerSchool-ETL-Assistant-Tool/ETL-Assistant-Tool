var AppNormalize = (function() {
    ...
    var scoresToMap = [
        ...
        , { TEST: "ACT", CODE: "ELA", FIELD: "ELA", MAP_FUNCTION: mapScaledScore }
        , { TEST: "ACT", CODE: "ACTSTEM", FIELD: "STEM", MAP_FUNCTION: mapScaledScore }
        , { TEST: "ACT", CODE: "ALT_MA", FIELD: "MATH_WY_ALT", MAP_FUNCTION: mapScaledScore }
        , { TEST: "ACT", CODE: "ALT_RD", FIELD: "READING_WY_ALT", MAP_FUNCTION: mapScaledScore }
        , { TEST: "ACT", CODE: "ALT_SC", FIELD: "SCIENCE_WY_ALT", MAP_FUNCTION: mapScaledScore }

        , { TEST: "ACT", CODE: "MATH_ALG_THINKING", FIELD: "MATH_OPERATIONS_AND_ALGEBRAIC_THINKING", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_NUM", FIELD: "MATH_NUMBERS_AND_OPERATIONS_BASE_TEN", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_FRAC", FIELD: "MATH_NUMBERS_AND_OPERATIONS_FRACTIONS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_MEAS", FIELD: "MATH_MEASUREMENT_AND_DATA", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_RT_PROP", FIELD: "MATH_RATIOS_AND_PROPORTIONAL_RELATIONSHIPS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_GEO", FIELD: "MATH_C_SCALE_GEOMETRY", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_MEAS", FIELD: "MATH_C_SCALE_MEASUREMENT", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_ALG", FIELD: "MATH_C_SCALE_OPS_ALGEBRA", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_BASE_TEN", FIELD: "PAWS_MATH_C_SCALE_BASE_TEN", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_FRAC", FIELD: "PAWS_MATH_C_SCALE_FRACTIONS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_EQN", FIELD: "PAWS_MATH_C_SCALE_EQUATIONS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_FUNC", FIELD: "PAWS_MATH_C_SCALE_FUNCTIONS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PAWS_MATH_NUM", FIELD: "PAWS_MATH_C_SCALE_NUMBER_SYS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_EXPN", FIELD: "MATH_EXPRESSIONS_AND_EQUATIONS", MAP_FUNCTION: mapRawScore }
        ...
        , { TEST: "ACT", CODE: "MATH_NQ", FIELD: "MATH_NUMBERS_AND_QUANTITIES", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_ALG", FIELD: "MATH_ALGEBRA", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_CON", FIELD: "MATH_CONGRUENCE", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_TRIG", FIELD: "MATH_SIMILARITY_RIGHT_TRIANGLES_AND_TRIGONOMETRY", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_GEO_EQN", FIELD: "MATH_EXPRESSING_GEOMETRIC_PROPERTIES_WITH_EQUATIONS", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "MATH_GEO_MOD", FIELD: "MATH_GEOMETRIC_MEASUREMENT_AND_DIMENSION_AND_MODELING", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "RD_LIT", FIELD: "READING_LITERATURE", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "RD_INF", FIELD: "READING_INFORMATIONAL", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "RD_VOC_ACQ", FIELD: "READING_LANGUAGE_VOCABULARY_ACQUISITION_AND_USE", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "RD_LISN", FIELD: "READING_ELA_LISTENING", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "RD_WRTN", FIELD: "READING_ELA_WRITING", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "SC_ER_SP", FIELD: "SCIENCE_EARTH_AND_SPACE", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "LIFE_SC", FIELD: "LIFE_SCIENCE", MAP_FUNCTION: mapRawScore }
        , { TEST: "ACT", CODE: "PHY_SCI", FIELD: "PHYSICAL_SCIENCE", MAP_FUNCTION: mapRawScore }
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "STUDENT_FIRST_NAME":
                    record.STUDENT_FIRST_NAME = _util.coalesce(row.getField("STUDENT_FIRST_NAME"),row.getField("FIRST_NAME"));
                    break;
                case "STUDENT_LAST_NAME":
                    record.STUDENT_LAST_NAME = _util.coalesce(row.getField("STUDENT_LAST_NAME"),row.getField("LAST_NAME"));
                    break;
