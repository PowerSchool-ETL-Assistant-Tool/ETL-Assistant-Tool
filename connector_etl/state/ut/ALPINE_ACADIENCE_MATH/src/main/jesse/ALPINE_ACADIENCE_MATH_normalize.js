var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "ALPINE_ACADIENCE_MATH";
    ...
    var scoresToMap = [
          {TEST: "ACADIENCE_MATH", CODE:"", FIELD: "", MAP_FUNCTION: mapOverallScore}
    ];
    ...
    var profLevelDecode = {
        "1" : { DESC:"Well Below Benchmark", PASS_IND: "No"}
       ,"2" : { DESC:"Below Benchmark", PASS_IND: "No"}
       ,"3" : { DESC:"At Benchmark", PASS_IND: "Yes"}
       ,"4" : { DESC:"Above Benchmark", PASS_IND: "Yes"}
       ,"" : null
       ,null : null
      };
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "REPORTING_PERIOD":
                    record.REPORTING_PERIOD = _util.coalesce(row.getField("ADMIN_PERIOD"));
                    break;
                ...
                case "TEST_ADMIN_PERIOD":
                    record.TEST_ADMIN_PERIOD = _util.coalesce(row.getField("ADMIN_PERIOD"));
                    break;
                ...
                case "DISTRICT_SCHOOL_ID":
                     record.SCHOOL_STATE_ID = _util.coalesce(row.getField("DISTRICT_SCHOOL_ID"));
                     break;
    ...
    function mapOverallScore(row, testMetadata) {
        ...
        var scaleScore = row.getField("RAW_SCORE");
        var proficiencyLvl = row.getField("PROFICIENCY_LEVEL");
        var growth = row.getField("GROWTH");
        var growthStatus = row.getField("GROWTH_STATUS");
    	...
    	score["TEST_PRIMARY_RESULT"] = profLevelDecode[proficiencyLvl].DESC;
    	score["TEST_PASSED_INDICATOR"] = profLevelDecode[proficiencyLvl].PASS_IND;
    	score["TEST_SECONDARY_RESULT_CODE"] = growth;
    	score["TEST_SECONDARY_RESULT"] = growthStatus;
