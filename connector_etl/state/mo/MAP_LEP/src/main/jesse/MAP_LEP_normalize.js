var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAP_LEP";
    ...
    var scoresToMap =
        [
            {TEST: "MAP_LEP", CODE: "OVR", FIELD:"TOTAL_BATTERY", MAP_FUNCTION: mapCompositeScore}
            ,{TEST: "MAP_LEP", CODE: "ORAL", FIELD: "ORAL", MAP_FUNCTION: mapScore}
            , {TEST: "MAP_LEP", CODE: "LIT", FIELD: "LITERACY", MAP_FUNCTION: mapScore}
            , {TEST: "MAP_LEP", CODE: "COMP", FIELD: "COMPREHENSION", MAP_FUNCTION: mapScore}
            , {TEST: "MAP_LEP", CODE: "LIS", FIELD: "LISTENING", MAP_FUNCTION: mapStrandScore}
            , {TEST: "MAP_LEP", CODE: "SPE", FIELD: "SPEAKING", MAP_FUNCTION: mapStrandScore}
            , {TEST: "MAP_LEP", CODE: "RD", FIELD: "READING", MAP_FUNCTION: mapStrandScore}
            , {TEST: "MAP_LEP", CODE: "WR", FIELD: "WRITING", MAP_FUNCTION: mapStrandScore}
        ];
    ...
    function mapStrandScore(row, testMetadata) {
        ...
        // Check for key fields and do not map score and exit if conditions met.
        if(_util.trim(scaleScore) === null || _util.trim(scaleScore) === undefined || _util.trim(scaleScore) === "" || inv === "Y") {
            return null;
        }
