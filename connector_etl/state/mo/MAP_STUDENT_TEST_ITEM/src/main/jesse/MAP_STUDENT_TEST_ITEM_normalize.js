var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAP_STUDENT_TEST_ITEM";
    ...
    var scoresToMap =
        [
            {TEST: "MAP_ST", CODE: "ITEM", TYPE: "MAP", FIELD:"", MAP_FUNCTION: mapItemScore}
        ];
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "TEST_ADMIN_DATE":
                    record.TEST_ADMIN_DATE = '05/01/' + row.getField("YEAR");
                    break;
    ...
    function mapAdditionalAdminFields(row) {
        var admin = {};
        admin.TEST_INTERVENTION_DESC = _util.coalesce(row.getField("ADMINISTRATION"));
        admin.TEST_INTERVENTION_CODE = "ADM";
        admin.TEST_INTERVENTION_DESC_2 = _util.coalesce(row.getField("SESSION_NUMBER"));
        admin.TEST_INTERVENTION_CODE_2 = "SESN";
        admin.TEST_INTERVENTION_DESC_3 = _util.coalesce(row.getField("CONDITION_CODE"));
        admin.TEST_INTERVENTION_CODE_3 = "COND";
    ...
    function mapItemScore(row, testMetadata) {
        ...
        var testNumber = generateTestNumber(row, testMetadata)+"_"+row.getField("ITEM_NUMBER");
        var itemID = row.getField("ITEM_ID");
        var scaleScore = row.getField("POINTS_EARNED");
        ...
        score["TEST_SCORE_ATTRIBUTES"] = itemID;
    ...
    function generateTestNumber(row, testMetadata) {
        ...
        testNumber = testMetadata.TEST + "_" + testMetadata.TYPE + "_" + testMetadata.CODE + "_" + area;
