var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAP_VAM_MATH";
    ...
    var scoresToMap =
        [
            {TEST: "MAP_VAM_MA", CODE: "NCET1", FIELD:"MATH_NCE_T1", MAP_FUNCTION: mapScore}
            ,{TEST: "MAP_VAM_MA", CODE: "NCET", FIELD:"MATH_NCE_T", MAP_FUNCTION: mapScore}
            ,{TEST: "MAP_VAM_MA", CODE: "NCEPRE", FIELD:"MATH_NCE_PREDICTED", MAP_FUNCTION: mapScore}
            ,{TEST: "MAP_VAM_MA", CODE: "NCERES", FIELD:"MATH_NCE_RESIDUAL", MAP_FUNCTION: mapScore}
        ];
