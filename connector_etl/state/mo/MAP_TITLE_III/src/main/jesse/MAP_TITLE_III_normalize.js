var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAP_TITLE_III";
    ...
    var scoresToMap =
        [
            {TEST: "MAP_TIII", CODE: "OVR", FIELD:"OVERALL", MAP_FUNCTION: mapCompositeScore}
            , {TEST: "MAP_TIII", CODE: "RD", FIELD: "READING", MAP_FUNCTION: mapStrandScore}
            , {TEST: "MAP_TIII", CODE: "WR", FIELD: "WRITING", MAP_FUNCTION: mapStrandScore}
            , {TEST: "MAP_TIII", CODE: "AMAO1", FIELD: "AMAO1_MET", MAP_FUNCTION: mapMetScore}
            , {TEST: "MAP_TIII", CODE: "AMAO2", FIELD: "AMAO2_MET", MAP_FUNCTION: mapMetScore}
            , {TEST: "MAP_TIII", CODE: "C1", FIELD: "COHORT_1", MAP_FUNCTION: mapMetScore}
            , {TEST: "MAP_TIII", CODE: "C2", FIELD: "COHORT_2", MAP_FUNCTION: mapMetScore}
        ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var testDateObject = {
                                   ...
                                   , DAY : null
                                   , YEAR : null
                                   , STANDARD_DATE : '05/01/' + row.getField("YEAR_ASSESSMENT")
                               };
        var birthDateObject = {
                                   RAW_DATE : null
                                   , MONTH : null
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "TEST_REPORTING_DATE":
                    record.TEST_REPORTING_DATE = '05/01/' + row.getField("YEAR_ASSESSMENT");
                    break;
                ...
                case "STUDENT_GRADE_CODE":
                    record.STUDENT_GRADE_CODE = _util.coalesce(row.getField("GRADE"));
                    break;
    ...
    function mapCompositeScore(row, testMetadata) {
        ...
        var performanceLevel = row.getField("OVERALL_PROFICIENCY_LEVEL");
        var performanceLevelOld = row.getField("OVERALL_PROFICIENCY_LEVEL_PRIOR_YR");
        var performanceLevelDiff = row.getField("OVERALL_PROFICIENCY_LEVEL_DIFF");
        ...
        score["TEST_SECONDARY_RESULT_CODE"] = performanceLevelOld;
        score["TEST_TERTIARY_RESULT_CODE"] = performanceLevelDiff;
    ...
    function mapMetScore(row, testMetadata) {
        var score = {};

        var testNumber = generateTestNumber(row, testMetadata);
        var performanceLevel = row.getField(testMetadata.FIELD);
        ...
        score["TEST_PASSED_INDICATOR"] = decodePassingLevel[performanceLevel];
