var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAP_VAM_COMM_ARTS";
    ...
    var scoresToMap =
        [
            {TEST: "MAP_VAM_COMM_ARTS", CODE: "NCET1", FIELD:"COMM_ARTS_NCE_T1", MAP_FUNCTION: mapScore}
            ,{TEST: "MAP_VAM_COMM_ARTS", CODE: "NCET", FIELD:"COMM_ARTS_NCE_T", MAP_FUNCTION: mapScore}
            ,{TEST: "MAP_VAM_COMM_ARTS", CODE: "NCEPRE", FIELD:"COMM_ARTS_NCE_PREDICTED", MAP_FUNCTION: mapScore}
            ,{TEST: "MAP_VAM_COMM_ARTS", CODE: "NCERES", FIELD:"COMM_ARTS_NCE_RESIDUAL", MAP_FUNCTION: mapScore}
        ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var testDateObject = {
                                   ...
                                   , DAY : null
                                   , YEAR : null
                                   , STANDARD_DATE : '05/01/' + row.getField("REPORT_YEAR")
                               };
        var birthDateObject = {
                                   RAW_DATE : null
                                   , MONTH : null
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "TEST_REPORTING_DATE":
                    record.TEST_REPORTING_DATE = '05/01/' + row.getField("REPORT_YEAR");
                    break;
    ...
    function mapScore(row, testMetadata) {
        ...
        var nce = row.getField(testMetadata.FIELD);


        // Check for key fields and do not map score and exit if conditions met.
        if(_util.trim(nce) === null || _util.trim(nce) === undefined || _util.trim(nce) === "") {
            return null;
        }

        // Set score fields
        score["TEST_NUMBER"] = testNumber;
        score["TEST_SCORE_TEXT"] = nce;
        score["TEST_SCORE_VALUE"] = nce;
