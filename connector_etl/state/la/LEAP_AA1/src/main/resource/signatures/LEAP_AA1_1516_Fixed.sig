{
  ...
  "format": {
    "@type": "Fixed Length",
    "formatName": "LEAP_AA1_1516_Fixed",
    "recordLength": 703,
		"naturalKey": ["LASID", "DRC_UNIQUE_STUDENT_ID", "ASSESSMENT_ACHIEVEMENT_LEVEL_ELA", "ASSESSMENT_ACHIEVEMENT_LEVEL_MATH", "ASSESSMENT_ACHIEVEMENT_LEVEL_SCIENCE", "TEST_DATE_MONTH", "TEST_DATE_YEAR"],
		"fields": [{
			...
			{
				"physicalName": "Algebra and Patterns Raw Score",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Measurement and Geometry Raw Score",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Numbers Raw Score",
				"otherPossibleNames": [],
