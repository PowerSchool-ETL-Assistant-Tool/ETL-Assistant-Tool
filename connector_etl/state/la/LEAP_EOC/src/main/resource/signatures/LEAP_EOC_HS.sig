{
  ...
  "format": {
    "@type": "Delimited",
    "formatName": "LEAP_EOC_HS",
    "quoteDelim": "\"",
    "fieldDelim": null,
    "hasHeader": true,
    "naturalKey": ["LASID", "TEST_ALGI", "TEST_ENGII", "TEST_GEOM", "TEST_BIO", "TEST_ENGIII", "TEST_ENGI", "TEST_USHIST_2025", "TEST_BIO_2025", "ADMINISTRATIONDATE"],
    "fields": [{
      ...
      },
      {
        ...
        "fieldLength": 2,
        "expectedValues": ["06", "07", "08", "T9", "09", "10", "11", "12"],
        "dataTypes": "STRING",
        "scale": null
      },
      {
      ...
      },
      {
        ...
        "fieldLength": 5,
        "expectedValues": ["AL", "ALAE", "ALNFT", "ALS", ""],
        "dataTypes": "STRING",
        "scale": null
      },
      {
      ...
      },
      {
        ...
        "fieldLength": 5,
        "expectedValues": ["E1", "E1AE", "E1NFT", "E1S", ""],
        "dataTypes": "STRING",
        "scale": null
      },
      {
      ...
      },
      {
        ...
        "fieldLength": 5,
        "expectedValues": ["USL", "USLAE", "USLNFT", ""],
        "dataTypes": "STRING",
        "scale": null
      },
      {
      ...
      },
      {
        ...
        "fieldLength": 5,
        "expectedValues": ["BLL", "BLLAE", "BLLNFT", ""],
        "dataTypes": "STRING",
        "scale": null
      },
      {
      ...
      {
        "physicalName": "BLLReportingCategoryRating",
        "otherPossibleNames": [],
        "logicalName": "BLLREPORTINGCATEGORYRATING",
        "formatMask": null,
        "isFieldRequired": "Y",
        "canBeNull": "Y",
        "fieldOffset": {
