{
	...
	"format": {
		"@type": "Delimited",
		"formatName": "LEAP_3_8_2021",
		"quoteDelim": "\"",
		"fieldDelim": ",",
		"recordLength": "",
		"hasHeader": true,
		"naturalKey": ["LASID","STUDENT_LAST_NAME","STUDENT_FIRST_NAME","STUDENT_MIDDLE_INITIAL","SCHOOL_CODE"],
		"fields": [{
			...
			},
			{
				...
				"otherPossibleNames": ["Limited English Proficient"],
			...
			},
			{
				...
				"otherPossibleNames": ["Summarized McKinney Vento Act"],
			...
			},
			{
				...
				"otherPossibleNames": ["Operations & Rational Numbers"],
			...
			{
				"physicalName": "Reason Scientifically",
				"otherPossibleNames": [],
