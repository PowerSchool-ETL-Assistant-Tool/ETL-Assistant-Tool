...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/PSAT_SAT_normalize.js");
    ...
    AppConnectorTest.QUnit.test("PSAT_SAT TESTS", function (assert) {
    ...
    AppConnectorTest.QUnit.test("DATE TRANSFORMATION TESTS", function (assert) {
        assert.equal(AppNormalize.mapDateObject(null, null, '2011-06-22').STANDARD_DATE, '06/22/2011', "yyyy-MM-dd Date Transform works #1");
        assert.equal(AppNormalize.mapDateObject(null, null, '2011-10-30').STANDARD_DATE, '10/30/2011', "yyyy-MM-dd Date Transform works #2");
    });
