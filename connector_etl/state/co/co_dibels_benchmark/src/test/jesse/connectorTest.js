...
function main() {
    ...
    load("${CONNECTOR_PATH}/src/main/jesse/CO_DIBELS_BENCHMARK_normalize.js");
    ...
    AppConnectorTest.QUnit.test("CO_DIBELS_BENCHMARK TESTS", function (assert) {
    ...
    AppConnectorTest.QUnit.test("DATE TRANSFORMATION TESTS", function (assert) {
        assert.equal(AppNormalize.mapDateObject(null, null, '05/05/2005').STANDARD_DATE, '05/05/2005');
        assert.equal(AppNormalize.mapDateObject(null, null, '2005-05-05').STANDARD_DATE, '05/05/2005');
    });
