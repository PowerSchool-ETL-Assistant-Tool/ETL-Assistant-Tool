var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "CO Dibels Prog Mon";
    ...
    ***************************************************************************/
    ...
    var strandsAndFields =
        [
            ...
            // DIBELS NEXT STRANDS
            {TEST: "DIBNXT", STRAND: "PROGMON"    , FIELD: "PROGMON"}
        ];
    ...
    function mapSingleNormalizedRecord(signature, hierarchy, row, year) {
        ...
        strandsAndFields.forEach(function(strandsAndField) {
            ...
            mappingObject.SCORE_MAPPINGS.push(
                {
                    "TEST_NUMBER" : "DIBNXT" + gradeLevels[row.getField("GRADE")] + getShortAdminPeriod(row.getField("PM_PERIOD")) +measure+"_PROGMON",
