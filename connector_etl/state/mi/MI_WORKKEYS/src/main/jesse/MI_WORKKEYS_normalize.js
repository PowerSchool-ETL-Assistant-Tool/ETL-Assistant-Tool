var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MI_WORKKEYS";
    ...
    var scoresToMap = [
        {TEST: "MI_WORKKEYS_", CODE:"OVR_MA", FIELD: "MATH_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "MI_WORKKEYS_", CODE:"OVR_GL", FIELD: "GRAPHICLITERACY_", MAP_FUNCTION: mapScaledScore}
        ,{TEST: "MI_WORKKEYS_", CODE:"OVR_WPD", FIELD: "WORKPLACEDOCUMENTS_", MAP_FUNCTION: mapScaledScore}
    ];
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "STUDENT_LOCAL_ID":
                    record.STUDENT_LOCAL_ID = _util.coalesce(row.getField("STUDENTNUMBER"));
                    break;
                case "STUDENT_STATE_ID":
                    record.STUDENT_STATE_ID = _util.coalesce(row.getField("STATE_STUDENT_ID"));
                    break;
                case "STUDENT_VENDOR_ID":
                    record.STUDENT_VENDOR_ID = _util.coalesce(row.getField("STUDENTNUMBER"));
                    break;
                ...
                case "SCHOOL_VENDOR_ID":
                    record.SCHOOL_VENDOR_ID = _util.coalesce(row.getField("SCHOOL_CODE"));
                    break;
