{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 4 Scale Score",
				"otherPossibleNames": [],
				"logicalName": "MA_04_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 4 Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "MA_04_STDERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 4 Performance",
				"otherPossibleNames": [],
				"logicalName": "MA_04_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_04_REASONING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_04_PROCEDURES_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_04_PROBLEMSOLVING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
