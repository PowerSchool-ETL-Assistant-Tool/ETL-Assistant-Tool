{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Grade 8 ELA - Summative (Online) Scale Score",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Grade 8 ELA - Summative (Online) Scale Score Standard Error",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Grade 8 ELA - Summative (Online) Performance",
				"otherPossibleNames": [],
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "ELA_08_WRITINGRESEARCH_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
