{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Grade 5 ELA - Summative (Online) Scale Score",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Grade 5 ELA - Summative (Online) Scale Score Standard Error",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Grade 5 ELA - Summative (Online) Performance",
				"otherPossibleNames": [],
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "ELA_05_WRITINGRESEARCH_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
