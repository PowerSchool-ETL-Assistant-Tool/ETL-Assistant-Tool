{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 7 Scale Score",
				"otherPossibleNames": [],
				"logicalName": "MA_07_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 7 Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "MA_07_STDERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 7 Performance",
				"otherPossibleNames": [],
				"logicalName": "MA_07_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_07_REASONING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_07_PROCEDURES_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_07_PROBLEMSOLVING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
