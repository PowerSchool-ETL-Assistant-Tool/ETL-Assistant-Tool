{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 6 Scale Score",
				"otherPossibleNames": [],
				"logicalName": "MA_06_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 6 Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "MA_06_STDERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 6 Performance",
				"otherPossibleNames": [],
				"logicalName": "MA_06_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_06_REASONING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_06_PROCEDURES_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_06_PROBLEMSOLVING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
