{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 5 Scale Score",
				"otherPossibleNames": [],
				"logicalName": "MA_05_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 5 Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "MA_05_STDERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 5 Performance",
				"otherPossibleNames": [],
				"logicalName": "MA_05_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_05_REASONING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_05_PROCEDURES_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_05_PROBLEMSOLVING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
