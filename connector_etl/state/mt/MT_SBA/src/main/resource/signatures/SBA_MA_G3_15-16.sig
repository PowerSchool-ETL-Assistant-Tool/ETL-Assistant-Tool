{
	...
	"format": {
		...
		"fields": [
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 3 Scale Score",
				"otherPossibleNames": [],
				"logicalName": "MA_03_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 3 Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "MA_03_STDERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Smarter Summative Mathematics Grade 3 Performance",
				"otherPossibleNames": [],
				"logicalName": "MA_03_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_03_REASONING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_03_PROCEDURES_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "MA_03_PROBLEMSOLVING_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
