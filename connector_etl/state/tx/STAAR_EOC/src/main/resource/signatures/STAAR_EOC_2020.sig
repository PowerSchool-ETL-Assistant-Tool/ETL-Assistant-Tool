{
	...
	"format": {
		...
		"fields": [{
			...
			{
				"physicalName": "FALL_TSDS_PEIMS_CDC",
				"otherPossibleNames": [],
				"logicalName": "FALL_TSDS_PEIMS_COUNTY_DISTRICT_CAMPUS_NUMBER",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "FALL_TSDS_PEIMS_CC",
				"otherPossibleNames": [],
				"logicalName": "FALL_TSDS_PEIMS_CRISIS_CODE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "FALL_TSDS_PEIMS_S_ATTRIBUTION",
				"otherPossibleNames": [],
				"logicalName": "FALL_TSDS_PEIMS_S_ATTRIBUTION",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "FALL_TSDS_PEIMS_Military",
				"otherPossibleNames": [],
				"logicalName": "FALL_TSDS_PEIMS_MILITARY",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "FALL_TSDS_Foster_Care_Indicator",
				"otherPossibleNames": [],
				"logicalName": "FALL_TSDS_FOSTER_CARE_INDICATOR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "FALL_TSDS_DYSLEXIA_CDE",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Test_Form_Vrsn",
				"otherPossibleNames": [],
				"logicalName": "TEST_FORM_VRSN",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "Alt_TAAS_TEAMS_A1_Perf",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Alt_TAAS_TEAMS_Bio_Perf",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Alt_TAAS_TEAMS_E2_Perf",
				"otherPossibleNames": [],
			...
			{
				"physicalName": "Alt_TAAS_TEAMS_USH_Perf",
				"otherPossibleNames": [],
