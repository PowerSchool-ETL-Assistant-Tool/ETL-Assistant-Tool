var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAP_READING_FLUENCY";
     ...
     ***************************************************************************/
    var scoresToMap = [
        {TEST: "MAP_RF", CODE: "PC", TYPE: "MAP", FIELD:"PRINT_CONCEPT_", MAP_FUNCTION: mapScoredTest},
        {TEST: "MAP_RF", CODE: "LC", TYPE: "MAP", FIELD:"LISTENING_COMPREHENSION_", MAP_FUNCTION: mapScoredTest},
        {TEST: "MAP_RF", CODE: "LT", TYPE: "MAP", FIELD:"LITERAL_COMPREHENSION_", MAP_FUNCTION: mapScoredTest},
        {TEST: "MAP_RF", CODE: "LN", TYPE: "MAP", FIELD:"LANGUAGE_COMPREHENSION_", MAP_FUNCTION: mapScoredTest},
        {TEST: "MAP_RF", CODE: "PV", TYPE: "MAP", FIELD:"PICTURE_VOCAB_", MAP_FUNCTION: mapScoredTest},
        {TEST: "MAP_RF", CODE: "SR", TYPE: "MAP", FIELD:"SENTENCE_READING_FLUENCY_", MAP_FUNCTION: mapScoredTest},
        {TEST: "MAP_RF", CODE: "PA", TYPE: "MAP", FIELD:"PHONOLOGICAL_AWARENESS_", MAP_FUNCTION: mapZPDTest},
        {TEST: "MAP_RF", CODE: "PW", TYPE: "MAP", FIELD:"PHONICS_WORD_RECOGNITION_", MAP_FUNCTION: mapZPDTest},
        {TEST: "MAP_RF", CODE: "OR", TYPE: "MAP", FIELD:"ORAL_READING_", MAP_FUNCTION: mapOralReadingTest},
        {TEST: "MAP_RF", CODE: "PM", TYPE: "MAP", FIELD:"PROGRESS_MONITORING_", MAP_FUNCTION: mapProgressMonitoringTest}
    ];
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var birthDateStr = _util.coalesce(row.getField("STUDENT_BIRTHDATE"), "");
         if(birthDateStr.indexOf("/")>-1){
                var birthDateObject = AppUtil.getDateObjByPattern(birthDateStr, "MM/dd/yyyy");
            }else{
                var birthDateObject = AppUtil.getDateObjByPattern(birthDateStr, "yyyy-MM-dd");
            }
