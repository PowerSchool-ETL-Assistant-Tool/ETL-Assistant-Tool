{
  ...
  "format": {
    ...
    "fieldDelim": ",",
    "quoteDelim": "\"",
    "formatName": "Subscore_Bio_Molecular",
    "hasHeader": true,
    "naturalKey": [
      "SCHOOL_VENDOR_ID", "STUDENT_LOCAL_ID"
    ],
    "fields": [
       {
