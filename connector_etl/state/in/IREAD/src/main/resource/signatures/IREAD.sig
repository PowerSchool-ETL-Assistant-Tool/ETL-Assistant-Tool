{
	...
	"format": {
		...
		"fieldDelim": ",",
		"hasHeader": true,
		"naturalKey": ["STUDENT_GRADE_CODE","STUDENT_STATE_ID","TEST_DATE"],
		"fields": [
            {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "IDENTIFIED_ENG_LEARNING_STATUS",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
{
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "CAREER_READINESS_INDICATOR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": ["Ping Status"],
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "ARGUMENTATIVE_EVIDENCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "INFORMATIVE_PURPOSE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "INFORMATIVE_EVIDENCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "NARRATIVE_EVIDENCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "PERSUASIVE_PURPOSE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			},
			{
				...
				"otherPossibleNames": [],
				"logicalName": "PERSUASIVE_EVIDENCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
