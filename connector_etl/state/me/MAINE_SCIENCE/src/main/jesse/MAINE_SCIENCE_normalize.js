var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "MAINE_SCIENCE";
    ...
    var scoresToMap = [
        {TEST: "MAINE_SCI_", MAP_FUNCTION: mapScaledScore}
    ...
    var passDecode = {
      ...
      var subjectDecodes = {
      "Maze Adjusted Score" : "MZE_ADJ",
      "NWF CLS": "NWF_CLS",
      "NWF WWR": "NWF_WWR",
      "ORF Accuracy": "ORF_ACCURACY",
      "ORF WC": "ORF_WC",
      "Retell": "RETELL",
      "Retell Quality": "RETELL_QUA",
      }
    /***********************************************************************************
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var testDateObject=row.getField("TEST_ADMIN_DATE");
            var finalDate = null;
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "STUDENT_LOCAL_ID":
                    record.STUDENT_LOCAL_ID = _util.coalesce(row.getField("STUDENT_SIS_ID"));
                    break;
                ...
                case "SCHOOL_VENDOR_ID":
                    record.SCHOOL_VENDOR_ID = _util.coalesce(row.getField("SCHOOL_SIS_ID"), row.getField("SCHOOL_LOCAL_ID"),row.getField("SCHOOL_STATE_ID"));
                    break;
                case "SCHOOL_NAME":
                    record.SCHOOL_NAME = row.getField("SCHOOL_NAME");
                    break;
                case "SCHOOL_LOCAL_ID":
                     record.SCHOOL_LOCAL_ID = _util.coalesce(row.getField("SCHOOL_NCES_ID"));
                     break;
                case "SCHOOL_STATE_ID":
                     record.SCHOOL_STATE_ID = _util.coalesce(row.getField("SCHOOL_SIS_ID"));
                     break;
    ...
    function mapScaledScore(row, testMetadata) {
        var score = {};
        var scoreType = row.getField("SCORE_TYPE");
        var subjectDecode = subjectDecodes[scoreType];
        var testNumber = testMetadata.TEST + subjectDecode;
        var scaleScore = row.getField("SCALE_SCORE");
		var achievLevel = row.getField("MONITOR_LEVEL");
    	...
    	score["TEST_SCORE_ATTRIBUTES"] = scoreType;
        return score;
    }
    ...
    function generateAssessmentAdminKey(signature, hierarchy, srcRecord) {
        ...
        var date = AppUtil.getDateObjByPattern(srcRecord.getField("TEST_ADMIN_DATE"), "yyyy-MM-dd").STANDARD_DATE;
        assessmentAdminKey = assessmentAdminKey + "_" + date;
