{
    ...
    "format": {
		...
		"fields": [{
			...
			{
				"physicalName": "CTAA Grade 11 ELA Scale Score",
				"otherPossibleNames": [],
				"logicalName": "CTAA_ELA_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "CTAA Grade 11 ELA Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "CTAA_ELA_SCALE_SCORE_STANDARD_ERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "CTAA Grade 11 ELA Performance",
				"otherPossibleNames": [],
				"logicalName": "CTAA_ELA_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
