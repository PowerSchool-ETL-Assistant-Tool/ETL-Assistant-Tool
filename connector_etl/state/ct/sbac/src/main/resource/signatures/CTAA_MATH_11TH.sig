{
    ...
    "format": {
		...
		"fields": [{
			...
			{
				"physicalName": "CTAA Grade 11 Math Scale Score",
				"otherPossibleNames": [],
				"logicalName": "CTAA_MATH_SCALE_SCORE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "CTAA Grade 11 Math Scale Score Standard Error",
				"otherPossibleNames": [],
				"logicalName": "CTAA_MATH_SCALE_SCORE_STANDARD_ERROR",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
			...
			{
				"physicalName": "CTAA Grade 11 Math Performance",
				"otherPossibleNames": [],
				"logicalName": "CTAA_MATH_PERFORMANCE",
				"formatMask": null,
				"isFieldRequired": "Y",
				"canBeNull": "Y",
				"fieldOffset": {
