var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "VTSA_NGSS";
    ...
    var scoresToMap =
    [   // SCIENCE SCORES AND PERFORMANCE
        {TEST: "VTSA_NGSS", CODE:"OVR", FIELD:"OVERALL", MAP_FUNCTION: mapScaledScore}
    ...
    var primaryDecode = {
       ...
       ,"Beginning to Meet Expectations" : "BME"
	   ,"Beginning": "Level 1"
       ,"Approaching": "Level 2"
       ,"Meets": "Level 3"
       ,"Exceeds ": "Level 4"
       ,"Insufficient to score" : "Insufficient to score"
       ,"" : null
       ,null : null
    };
    ...
    var decodePassedInd = {
         "Beginning to Meet Expectations": "No"
    ...
    function mapNormalizedAdminFields(signature, hierarchy, row) {
        ...
        var testDateObject = parseDate(testDate);
        ...
        if (row.getField('STUDENT_NAME')) {
            ...
            studentFirstName = row.getField('FIRST_NAME');
            studentLastName = row.getField('LAST_NAME');
            studentMiddleName = row.getField('MIDDLE_NAME');
        }
        ...
        normalizedFileFields.forEach(function (field) {
            switch(field) {
                ...
                case "STUDENT_GRADE_CODE":
                    record.STUDENT_GRADE_CODE = _util.coalesce(gradeDecode[row.getField('ENROLLED_GRADE')], gradeDecode[row.getField('TEST_GRADE')]);
                    break;
    ...
    function mapScaledScore(row, testMetadata) {
        ...
        var grade = row.getField("TEST_GRADE").split(" ")[1];

        if(subject && grade ) {
            var testNumber = testMetadata.TEST + "_" + subjectDecode[subject] + "_" + gradeDecode[grade] ;
        } else {
            var testNumber = testMetadata.TEST + "_" + testMetadata.CODE;
        }

        var scaleScore = row.getField("SCALE_SCORE");
        var sem = row.getField("STANDARD_ERROR");
    	...
    	score["TEST_PASSED_INDICATOR"] = decodePassedInd[achievLevel];
        if(!isNaN(sem)){
