var AppNormalize = (function() {
    ...
    var _assessmentIdentifier = "ACTIVELY_LEARN";
    ...
    var scoresToMap = [
        {TEST: "PRDCT", CODE:"ELA", FIELD: "ENGLISH_", MAP_FUNCTION: mapScaledScore}
    ...
    function mapScaledScore(row, testMetadata) {
        ...
        var percentileLower = row.getField("PERCENTILE_LOWER");
        var percentileUpper = row.getField("PERCENTILE_HIGHER");
